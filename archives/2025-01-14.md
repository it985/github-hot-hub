...
`最后更新时间：2025-01-14 00:23:37 +0800`

## 今日热门仓库

1. [FujiwaraChoki / MoneyPrinterV2](https://github.com/FujiwaraChoki/MoneyPrinterV2)
    - Automate the process of making money online.
    - language: **Python** &nbsp;&nbsp; stars: **3,900** &nbsp;&nbsp; folks: **433**  &nbsp;&nbsp; `129 stars today`
...
1. [TabbyML / tabby](https://github.com/TabbyML/tabby)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **23,931** &nbsp;&nbsp; folks: **1,096**  &nbsp;&nbsp; `1,076 stars today`

1. [kamranahmedse / developer-roadmap](https://github.com/kamranahmedse/developer-roadmap)
    - Interactive roadmaps, guides and other educational content to help developers grow in their careers.
    - language: **TypeScript** &nbsp;&nbsp; stars: **305,367** &nbsp;&nbsp; folks: **39,964**  &nbsp;&nbsp; `490 stars today`
...
1. [MagicMirrorOrg / MagicMirror](https://github.com/MagicMirrorOrg/MagicMirror)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **20,506** &nbsp;&nbsp; folks: **4,256**  &nbsp;&nbsp; `298 stars today`
...
1. [ubicloud / ubicloud](https://github.com/ubicloud/ubicloud)
    ...
    - language: **Ruby** &nbsp;&nbsp; stars: **4,068** &nbsp;&nbsp; folks: **132**  &nbsp;&nbsp; `206 stars today`
...
1. [automatisch / automatisch](https://github.com/automatisch/automatisch)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **6,936** &nbsp;&nbsp; folks: **508**  &nbsp;&nbsp; `21 stars today`

1. [kevmo314 / scuda](https://github.com/kevmo314/scuda)
    - SCUDA is a GPU over IP bridge allowing GPUs on remote machines to be attached to CPU-only machines.
    - language: **C++** &nbsp;&nbsp; stars: **1,058** &nbsp;&nbsp; folks: **39**  &nbsp;&nbsp; `139 stars today`
...
1. [unclecode / crawl4ai](https://github.com/unclecode/crawl4ai)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **24,300** &nbsp;&nbsp; folks: **1,782**  &nbsp;&nbsp; `4,051 stars this week`
...
1. [kamranahmedse / developer-roadmap](https://github.com/kamranahmedse/developer-roadmap)
    - Interactive roadmaps, guides and other educational content to help developers grow in their careers.
    - language: **TypeScript** &nbsp;&nbsp; stars: **305,367** &nbsp;&nbsp; folks: **39,964**  &nbsp;&nbsp; `1,245 stars this week`
...
1. [unclecode / crawl4ai](https://github.com/unclecode/crawl4ai)
    - 🚀🤖 Crawl4AI: Open-source LLM Friendly Web Crawler & Scraper
    - language: **Python** &nbsp;&nbsp; stars: **24,300** &nbsp;&nbsp; folks: **1,782**  &nbsp;&nbsp; `5,700 stars this month`
