...
1. [dittofeed / dittofeed](https://github.com/dittofeed/dittofeed)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **1,636** &nbsp;&nbsp; folks: **145**  &nbsp;&nbsp; `56 stars today`
...
1. [Guovin / TV](https://github.com/Guovin/TV)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **3,379** &nbsp;&nbsp; folks: **788**  &nbsp;&nbsp; `511 stars today`
...
1. [sadmann7 / shadcn-table](https://github.com/sadmann7/shadcn-table)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,808** &nbsp;&nbsp; folks: **240**  &nbsp;&nbsp; `72 stars today`
...
1. [OpenInterpreter / open-interpreter](https://github.com/OpenInterpreter/open-interpreter)
    - A natural language interface for computers
    - language: **Python** &nbsp;&nbsp; stars: **53,160** &nbsp;&nbsp; folks: **4,693**  &nbsp;&nbsp; `236 stars this week`
...
1. [phidatahq / phidata](https://github.com/phidatahq/phidata)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **13,685** &nbsp;&nbsp; folks: **1,926**  &nbsp;&nbsp; `2,113 stars this week`

1. [Guovin / TV](https://github.com/Guovin/TV)
    - 📺IPTV电视直播源更新工具🚀：包含💰央视(付费)、📡卫视、🏠广东、🌊港·澳·台、🎬电影、🎥咪咕、🏀体育、🪁动画、🎮游戏、🎵音乐、🏛经典剧场；支持自定义增加频道；支持组播源、酒店源、订阅源、关键字搜索；每天自动更新两次，结果可用于TVBox等播放软件；支持工作流、Docker(amd64/arm64)、命令行、GUI运行方式 | IPTV live TV source update tool
    - language: **Python** &nbsp;&nbsp; stars: **3,379** &nbsp;&nbsp; folks: **788**  &nbsp;&nbsp; `2,083 stars this week`
...
1. [3b1b / manim](https://github.com/3b1b/manim)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **69,133** &nbsp;&nbsp; folks: **6,124**  &nbsp;&nbsp; `7,143 stars this month`
...
1. [mediar-ai / screenpipe](https://github.com/mediar-ai/screenpipe)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **8,384** &nbsp;&nbsp; folks: **472**  &nbsp;&nbsp; `6,867 stars this month`
...
1. [phidatahq / phidata](https://github.com/phidatahq/phidata)
    - Build AI Agents with memory, knowledge, tools and reasoning. Chat with them using a beautiful Agent UI.
    - language: **Python** &nbsp;&nbsp; stars: **13,685** &nbsp;&nbsp; folks: **1,926**  &nbsp;&nbsp; `2,394 stars this month`
...
1. [twentyhq / twenty](https://github.com/twentyhq/twenty)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **17,601** &nbsp;&nbsp; folks: **2,076**  &nbsp;&nbsp; `1,749 stars this month`
