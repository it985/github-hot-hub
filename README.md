...
`更新时间：2025-01-10 22:16:32 +0800`

## 今日热门仓库

1. [78 / xiaozhi-esp32](https://github.com/78/xiaozhi-esp32)
    - Build your own AI friend
    - language: **C** &nbsp;&nbsp; stars: **2,258** &nbsp;&nbsp; folks: **365**  &nbsp;&nbsp; `321 stars today`
...
1. [srbhr / Resume-Matcher](https://github.com/srbhr/Resume-Matcher)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **7,216** &nbsp;&nbsp; folks: **2,580**  &nbsp;&nbsp; `486 stars today`
...
1. [feder-cr / Jobs_Applier_AI_Agent](https://github.com/feder-cr/Jobs_Applier_AI_Agent)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **24,570** &nbsp;&nbsp; folks: **3,647**  &nbsp;&nbsp; `176 stars today`

1. [browserbase / stagehand](https://github.com/browserbase/stagehand)
    - An AI web browsing framework focused on simplicity and extensibility.
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,972** &nbsp;&nbsp; folks: **160**  &nbsp;&nbsp; `662 stars today`
...
1. [khoj-ai / khoj](https://github.com/khoj-ai/khoj)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **23,765** &nbsp;&nbsp; folks: **1,257**  &nbsp;&nbsp; `803 stars today`

1. [inkonchain / docs](https://github.com/inkonchain/docs)
    - Ink Documentation
    - language: **MDX** &nbsp;&nbsp; stars: **19,210** &nbsp;&nbsp; folks: **199**  &nbsp;&nbsp; `2,365 stars today`

1. [inkonchain / node](https://github.com/inkonchain/node)
    - How to run an Ink Node
    - language: **Shell** &nbsp;&nbsp; stars: **19,279** &nbsp;&nbsp; folks: **291**  &nbsp;&nbsp; `2,373 stars today`
...
1. [stanford-oval / storm](https://github.com/stanford-oval/storm)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **19,392** &nbsp;&nbsp; folks: **1,697**  &nbsp;&nbsp; `5,127 stars this week`
...
1. [78 / xiaozhi-esp32](https://github.com/78/xiaozhi-esp32)
    - Build your own AI friend
    - language: **C** &nbsp;&nbsp; stars: **2,258** &nbsp;&nbsp; folks: **365**  &nbsp;&nbsp; `1,005 stars this week`

1. [cline / cline](https://github.com/cline/cline)
    - Autonomous coding agent right in your IDE, capable of creating/editing files, executing commands, using the browser, and more with your permission every step of the way.
    - language: **TypeScript** &nbsp;&nbsp; stars: **21,165** &nbsp;&nbsp; folks: **1,798**  &nbsp;&nbsp; `2,409 stars this week`
...
1. [stanford-oval / storm](https://github.com/stanford-oval/storm)
    - An LLM-powered knowledge curation system that researches a topic and generates a full-length report with citations.
    - language: **Python** &nbsp;&nbsp; stars: **19,392** &nbsp;&nbsp; folks: **1,697**  &nbsp;&nbsp; `5,764 stars this month`

1. [cline / cline](https://github.com/cline/cline)
    - Autonomous coding agent right in your IDE, capable of creating/editing files, executing commands, using the browser, and more with your permission every step of the way.
    - language: **TypeScript** &nbsp;&nbsp; stars: **21,165** &nbsp;&nbsp; folks: **1,798**  &nbsp;&nbsp; `6,941 stars this month`

1. [khoj-ai / khoj](https://github.com/khoj-ai/khoj)
    - Your AI second brain. Self-hostable. Get answers from the web or your docs. Build custom agents, schedule automations, do deep research. Turn any online or local LLM into your personal, autonomous AI (gpt, claude, gemini, llama, qwen, mistral). Get started - free.
    - language: **Python** &nbsp;&nbsp; stars: **23,765** &nbsp;&nbsp; folks: **1,257**  &nbsp;&nbsp; `6,281 stars this month`
...
1. [upscayl / upscayl](https://github.com/upscayl/upscayl)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **33,484** &nbsp;&nbsp; folks: **1,534**  &nbsp;&nbsp; `1,835 stars this month`
