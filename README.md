...
`更新时间：2023-01-28 18:15:18 +0800`

## 今日热门仓库

1. [shadcn / ui](https://github.com/shadcn/ui)
    - Beautifully designed components built with Radix UI and Tailwind CSS.
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,971** &nbsp;&nbsp; folks: **193**  &nbsp;&nbsp; `1,116 stars today`
...
1. [AzeemIdrisi / PhoneSploit-Pro](https://github.com/AzeemIdrisi/PhoneSploit-Pro)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **488** &nbsp;&nbsp; folks: **78**  &nbsp;&nbsp; `315 stars today`

1. [trekhleb / javascript-algorithms](https://github.com/trekhleb/javascript-algorithms)
    - 📝 Algorithms and data structures implemented in JavaScript with explanations and links to further readings
    - language: **JavaScript** &nbsp;&nbsp; stars: **161,653** &nbsp;&nbsp; folks: **26,737**  &nbsp;&nbsp; `253 stars today`

1. [LAION-AI / Open-Assistant](https://github.com/LAION-AI/Open-Assistant)
    - OpenAssistant is a chat-based assistant that understands tasks, can interact with third-party systems, and retrieve information dynamically to do so.
    - language: **Python** &nbsp;&nbsp; stars: **5,371** &nbsp;&nbsp; folks: **452**  &nbsp;&nbsp; `238 stars today`
...
1. [flutter / news_toolkit](https://github.com/flutter/news_toolkit)
    ...
    - language: **Dart** &nbsp;&nbsp; stars: **281** &nbsp;&nbsp; folks: **42**  &nbsp;&nbsp; `69 stars today`
...
1. [flutter / flutter](https://github.com/flutter/flutter)
    ...
    - language: **Dart** &nbsp;&nbsp; stars: **149,346** &nbsp;&nbsp; folks: **24,466**  &nbsp;&nbsp; `289 stars today`

1. [bregman-arie / devops-exercises](https://github.com/bregman-arie/devops-exercises)
    - Linux, Jenkins, AWS, SRE, Prometheus, Docker, Python, Ansible, Git, Kubernetes, Terraform, OpenStack, SQL, NoSQL, Azure, GCP, DNS, Elastic, Network, Virtualization. DevOps Interview Questions
    - language: **Python** &nbsp;&nbsp; stars: **36,014** &nbsp;&nbsp; folks: **8,241**  &nbsp;&nbsp; `89 stars today`
...
1. [localsend / localsend](https://github.com/localsend/localsend)
    ...
    - language: **Dart** &nbsp;&nbsp; stars: **777** &nbsp;&nbsp; folks: **28**  &nbsp;&nbsp; `200 stars today`
...
1. [huggingface / transformers](https://github.com/huggingface/transformers)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **79,063** &nbsp;&nbsp; folks: **17,724**  &nbsp;&nbsp; `137 stars today`

1. [dortania / OpenCore-Legacy-Patcher](https://github.com/dortania/OpenCore-Legacy-Patcher)
    - Experience macOS just like before
    - language: **Python** &nbsp;&nbsp; stars: **5,191** &nbsp;&nbsp; folks: **556**  &nbsp;&nbsp; `45 stars today`
...
1. [daveshap / LongtermChatExternalSources](https://github.com/daveshap/LongtermChatExternalSources)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **271** &nbsp;&nbsp; folks: **54**  &nbsp;&nbsp; `64 stars today`

1. [jlevy / the-art-of-command-line](https://github.com/jlevy/the-art-of-command-line)
    - Master the command line, in one page
    - language: **无** &nbsp;&nbsp; stars: **126,903** &nbsp;&nbsp; folks: **12,851**  &nbsp;&nbsp; `210 stars today`

1. [ripienaar / free-for-dev](https://github.com/ripienaar/free-for-dev)
    - A list of SaaS, PaaS and IaaS offerings that have free tiers of interest to devops and infradev
    - language: **HTML** &nbsp;&nbsp; stars: **66,218** &nbsp;&nbsp; folks: **7,192**  &nbsp;&nbsp; `99 stars today`

1. [catchorg / Catch2](https://github.com/catchorg/Catch2)
    - A modern, C++-native, test framework for unit-tests, TDD and BDD - using C++14, C++17 and later (C++11 support is in v2.x branch, and C++03 on the Catch1.x branch)
    - language: **C++** &nbsp;&nbsp; stars: **16,145** &nbsp;&nbsp; folks: **2,763**  &nbsp;&nbsp; `24 stars today`
...
1. [trufflesecurity / trufflehog](https://github.com/trufflesecurity/trufflehog)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **10,283** &nbsp;&nbsp; folks: **1,236**  &nbsp;&nbsp; `45 stars today`
...
1. [Mokshit06 / typewind](https://github.com/Mokshit06/typewind)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **1,344** &nbsp;&nbsp; folks: **14**  &nbsp;&nbsp; `262 stars today`
...
1. [LazyVim / LazyVim](https://github.com/LazyVim/LazyVim)
    ...
    - language: **Lua** &nbsp;&nbsp; stars: **2,694** &nbsp;&nbsp; folks: **157**  &nbsp;&nbsp; `2,150 stars this week`
...
1. [Dimillian / IceCubesApp](https://github.com/Dimillian/IceCubesApp)
    ...
    - language: **Swift** &nbsp;&nbsp; stars: **1,564** &nbsp;&nbsp; folks: **134**  &nbsp;&nbsp; `648 stars this week`
...
1. [trekhleb / javascript-algorithms](https://github.com/trekhleb/javascript-algorithms)
    - 📝 Algorithms and data structures implemented in JavaScript with explanations and links to further readings
    - language: **JavaScript** &nbsp;&nbsp; stars: **161,653** &nbsp;&nbsp; folks: **26,737**  &nbsp;&nbsp; `2,472 stars this week`

1. [jerryjliu / gpt_index](https://github.com/jerryjliu/gpt_index)
    - GPT Index is a project consisting of a set of data structures designed to make it easier to use large external knowledge bases with LLMs.
    - language: **Python** &nbsp;&nbsp; stars: **2,818** &nbsp;&nbsp; folks: **200**  &nbsp;&nbsp; `710 stars this week`
...
1. [dgtlmoon / changedetection.io](https://github.com/dgtlmoon/changedetection.io)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **7,817** &nbsp;&nbsp; folks: **445**  &nbsp;&nbsp; `237 stars this week`
...
1. [RasaHQ / rasa](https://github.com/RasaHQ/rasa)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **15,439** &nbsp;&nbsp; folks: **4,216**  &nbsp;&nbsp; `53 stars this week`

1. [google-research / tuning_playbook](https://github.com/google-research/tuning_playbook)
    - A playbook for systematically maximizing the performance of deep learning models.
    - language: **无** &nbsp;&nbsp; stars: **11,954** &nbsp;&nbsp; folks: **804**  &nbsp;&nbsp; `6,618 stars this week`
...
1. [LAION-AI / Open-Assistant](https://github.com/LAION-AI/Open-Assistant)
    - OpenAssistant is a chat-based assistant that understands tasks, can interact with third-party systems, and retrieve information dynamically to do so.
    - language: **Python** &nbsp;&nbsp; stars: **5,371** &nbsp;&nbsp; folks: **452**  &nbsp;&nbsp; `4,658 stars this month`
...
1. [lencx / ChatGPT](https://github.com/lencx/ChatGPT)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **6,469** &nbsp;&nbsp; folks: **503**  &nbsp;&nbsp; `4,663 stars this month`
...
1. [f / awesome-chatgpt-prompts](https://github.com/f/awesome-chatgpt-prompts)
    ...
    - language: **HTML** &nbsp;&nbsp; stars: **18,637** &nbsp;&nbsp; folks: **1,706**  &nbsp;&nbsp; `8,211 stars this month`
...
1. [google / comprehensive-rust](https://github.com/google/comprehensive-rust)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **8,575** &nbsp;&nbsp; folks: **378**  &nbsp;&nbsp; `5,277 stars this month`

1. [papers-we-love / papers-we-love](https://github.com/papers-we-love/papers-we-love)
    - Papers from the computer science community to read and discuss.
    - language: **Shell** &nbsp;&nbsp; stars: **68,856** &nbsp;&nbsp; folks: **5,061**  &nbsp;&nbsp; `2,314 stars this month`
...
1. [facebook / folly](https://github.com/facebook/folly)
    - An open-source C++ library developed and used at Facebook.
    - language: **C++** &nbsp;&nbsp; stars: **24,633** &nbsp;&nbsp; folks: **5,026**  &nbsp;&nbsp; `745 stars this month`
