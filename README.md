...
1. [fishaudio / fish-speech](https://github.com/fishaudio/fish-speech)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **16,773** &nbsp;&nbsp; folks: **1,259**  &nbsp;&nbsp; `1,926 stars this week`

1. [pydantic / pydantic-ai](https://github.com/pydantic/pydantic-ai)
    - Agent Framework / shim to use Pydantic with LLMs
    - language: **Python** &nbsp;&nbsp; stars: **3,586** &nbsp;&nbsp; folks: **205**  &nbsp;&nbsp; `2,129 stars this week`

1. [lobehub / lobe-chat](https://github.com/lobehub/lobe-chat)
    - 🤯 Lobe Chat - an open-source, modern-design AI chat framework. Supports Multi AI Providers( OpenAI / Claude 3 / Gemini / Ollama / Qwen / DeepSeek), Knowledge Base (file upload / knowledge management / RAG ), Multi-Modals (Vision/TTS/Plugins/Artifacts). One-click FREE deployment of your private ChatGPT/ Claude application.
    - language: **TypeScript** &nbsp;&nbsp; stars: **48,702** &nbsp;&nbsp; folks: **10,558**  &nbsp;&nbsp; `1,716 stars this week`
...
1. [bitcoin / bitcoin](https://github.com/bitcoin/bitcoin)
    - Bitcoin Core integration/staging tree
    - language: **C++** &nbsp;&nbsp; stars: **80,594** &nbsp;&nbsp; folks: **36,543**  &nbsp;&nbsp; `568 stars this week`

1. [krahets / hello-algo](https://github.com/krahets/hello-algo)
    - 《Hello 算法》：动画图解、一键运行的数据结构与算法教程。支持 Python, Java, C++, C, C#, JS, Go, Swift, Rust, Ruby, Kotlin, TS, Dart 代码。简体版和繁体版同步更新，English version ongoing
    - language: **Java** &nbsp;&nbsp; stars: **103,036** &nbsp;&nbsp; folks: **12,928**  &nbsp;&nbsp; `1,324 stars this week`

1. [imputnet / cobalt](https://github.com/imputnet/cobalt)
    - best way to save what you love
    - language: **Svelte** &nbsp;&nbsp; stars: **19,281** &nbsp;&nbsp; folks: **1,560**  &nbsp;&nbsp; `1,528 stars this week`
...
1. [ai16z / eliza](https://github.com/ai16z/eliza)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,868** &nbsp;&nbsp; folks: **1,107**  &nbsp;&nbsp; `889 stars this week`

1. [stanfordnlp / dspy](https://github.com/stanfordnlp/dspy)
    - DSPy: The framework for programming—not prompting—language models
    - language: **Python** &nbsp;&nbsp; stars: **20,029** &nbsp;&nbsp; folks: **1,514**  &nbsp;&nbsp; `527 stars this week`
...
1. [phidatahq / phidata](https://github.com/phidatahq/phidata)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **16,158** &nbsp;&nbsp; folks: **2,208**  &nbsp;&nbsp; `404 stars this week`

1. [FoundationVision / VAR](https://github.com/FoundationVision/VAR)
    - [NeurIPS 2024 Oral][GPT beats diffusion🔥] [scaling laws in visual generation📈] Official impl. of "Visual Autoregressive Modeling: Scalable Image Generation via Next-Scale Prediction". An *ultra-simple, user-friendly yet state-of-the-art* codebase for autoregressive image generation!
    - language: **Python** &nbsp;&nbsp; stars: **6,003** &nbsp;&nbsp; folks: **404**  &nbsp;&nbsp; `962 stars this week`
...
1. [skills / github-pages](https://github.com/skills/github-pages)
    ...
    - language: **无** &nbsp;&nbsp; stars: **1,361** &nbsp;&nbsp; folks: **746**  &nbsp;&nbsp; `534 stars this week`
...
1. [DataExpert-io / data-engineer-handbook](https://github.com/DataExpert-io/data-engineer-handbook)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **22,834** &nbsp;&nbsp; folks: **3,869**  &nbsp;&nbsp; `10,642 stars this month`

1. [ai16z / eliza](https://github.com/ai16z/eliza)
    - Autonomous agents for everyone
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,868** &nbsp;&nbsp; folks: **1,107**  &nbsp;&nbsp; `3,259 stars this month`

1. [opendatalab / MinerU](https://github.com/opendatalab/MinerU)
    - A high-quality tool for convert PDF to Markdown and JSON.一站式开源高质量数据提取工具，将PDF转换成Markdown和JSON格式。
    - language: **Python** &nbsp;&nbsp; stars: **21,013** &nbsp;&nbsp; folks: **1,489**  &nbsp;&nbsp; `7,229 stars this month`

1. [abi / screenshot-to-code](https://github.com/abi/screenshot-to-code)
    - Drop in a screenshot and convert it to clean code (HTML/Tailwind/React/Vue)
    - language: **Python** &nbsp;&nbsp; stars: **65,304** &nbsp;&nbsp; folks: **7,952**  &nbsp;&nbsp; `6,137 stars this month`

1. [dockur / macos](https://github.com/dockur/macos)
    - OSX (macOS) inside a Docker container.
    - language: **Python** &nbsp;&nbsp; stars: **9,575** &nbsp;&nbsp; folks: **346**  &nbsp;&nbsp; `8,334 stars this month`
...
1. [krahets / hello-algo](https://github.com/krahets/hello-algo)
    - 《Hello 算法》：动画图解、一键运行的数据结构与算法教程。支持 Python, Java, C++, C, C#, JS, Go, Swift, Rust, Ruby, Kotlin, TS, Dart 代码。简体版和繁体版同步更新，English version ongoing
    - language: **Java** &nbsp;&nbsp; stars: **103,036** &nbsp;&nbsp; folks: **12,928**  &nbsp;&nbsp; `5,136 stars this month`

1. [haydenbleasel / next-forge](https://github.com/haydenbleasel/next-forge)
    - Production-grade Turborepo template for Next.js apps.
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,517** &nbsp;&nbsp; folks: **356**  &nbsp;&nbsp; `2,588 stars this month`
...
1. [fishaudio / fish-speech](https://github.com/fishaudio/fish-speech)
    - SOTA Open Source TTS
    - language: **Python** &nbsp;&nbsp; stars: **16,773** &nbsp;&nbsp; folks: **1,259**  &nbsp;&nbsp; `2,489 stars this month`
...
1. [GoogleCloudPlatform / generative-ai](https://github.com/GoogleCloudPlatform/generative-ai)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **8,430** &nbsp;&nbsp; folks: **2,359**  &nbsp;&nbsp; `1,078 stars this month`
...
1. [Guovin / iptv-api](https://github.com/Guovin/iptv-api)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **8,455** &nbsp;&nbsp; folks: **1,832**  &nbsp;&nbsp; `3,578 stars this month`
...
1. [donnemartin / system-design-primer](https://github.com/donnemartin/system-design-primer)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **278,975** &nbsp;&nbsp; folks: **46,687**  &nbsp;&nbsp; `4,377 stars this month`
