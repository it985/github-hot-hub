...
1. [JoePenna / Dreambooth-Stable-Diffusion](https://github.com/JoePenna/Dreambooth-Stable-Diffusion)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **1,714** &nbsp;&nbsp; folks: **256**  &nbsp;&nbsp; `112 stars today`
...
1. [mikeroyal / Self-Hosting-Guide](https://github.com/mikeroyal/Self-Hosting-Guide)
    ...
    - language: **Dockerfile** &nbsp;&nbsp; stars: **2,354** &nbsp;&nbsp; folks: **80**  &nbsp;&nbsp; `674 stars today`
...
1. [vercel / next.js](https://github.com/vercel/next.js)
    - The React Framework
    - language: **JavaScript** &nbsp;&nbsp; stars: **94,702** &nbsp;&nbsp; folks: **20,832**  &nbsp;&nbsp; `243 stars today`
...
1. [PowerShell / PowerShell](https://github.com/PowerShell/PowerShell)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **35,724** &nbsp;&nbsp; folks: **6,008**  &nbsp;&nbsp; `85 stars today`
...
1. [WalletConnect / web3modal](https://github.com/WalletConnect/web3modal)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,601** &nbsp;&nbsp; folks: **867**  &nbsp;&nbsp; `52 stars today`

1. [jaywcjlove / linux-command](https://github.com/jaywcjlove/linux-command)
    - Linux命令大全搜索工具，内容包含Linux命令手册、详解、学习、搜集。https://git.io/linux
    - language: **Markdown** &nbsp;&nbsp; stars: **20,782** &nbsp;&nbsp; folks: **4,548**  &nbsp;&nbsp; `233 stars today`
...
1. [PowerShell / PowerShell](https://github.com/PowerShell/PowerShell)
    - PowerShell for every system!
    - language: **C#** &nbsp;&nbsp; stars: **35,724** &nbsp;&nbsp; folks: **6,008**  &nbsp;&nbsp; `397 stars this week`
...
1. [MichaelCade / 90DaysOfDevOps](https://github.com/MichaelCade/90DaysOfDevOps)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **19,304** &nbsp;&nbsp; folks: **4,167**  &nbsp;&nbsp; `614 stars this week`
...
1. [rustdesk / rustdesk](https://github.com/rustdesk/rustdesk)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **31,181** &nbsp;&nbsp; folks: **2,715**  &nbsp;&nbsp; `857 stars this week`
...
1. [AUTOMATIC1111 / stable-diffusion-webui](https://github.com/AUTOMATIC1111/stable-diffusion-webui)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **17,371** &nbsp;&nbsp; folks: **2,995**  &nbsp;&nbsp; `12,808 stars this month`
...
1. [JoePenna / Dreambooth-Stable-Diffusion](https://github.com/JoePenna/Dreambooth-Stable-Diffusion)
    - Implementation of Dreambooth (https://arxiv.org/abs/2208.12242) by way of Textual Inversion (https://arxiv.org/abs/2208.01618) for Stable Diffusion (https://arxiv.org/abs/2112.10752). Tweaks focused on training faces, objects, and styles.
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **1,714** &nbsp;&nbsp; folks: **256**  &nbsp;&nbsp; `1,299 stars this month`
...
1. [XavierXiao / Dreambooth-Stable-Diffusion](https://github.com/XavierXiao/Dreambooth-Stable-Diffusion)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **2,959** &nbsp;&nbsp; folks: **339**  &nbsp;&nbsp; `1,858 stars this month`
...
1. [inancgumus / learngo](https://github.com/inancgumus/learngo)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **16,185** &nbsp;&nbsp; folks: **2,115**  &nbsp;&nbsp; `1,215 stars this month`
...
1. [ToolJet / ToolJet](https://github.com/ToolJet/ToolJet)
    - Extensible low-code framework for building business applications. Connect to databases, cloud storages, GraphQL, API endpoints, Airtable, etc and build apps using drag and drop application builder. Built using JavaScript/TypeScript. 🚀
    - language: **JavaScript** &nbsp;&nbsp; stars: **14,464** &nbsp;&nbsp; folks: **1,298**  &nbsp;&nbsp; `1,222 stars this month`
...
1. [alist-org / alist](https://github.com/alist-org/alist)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **11,261** &nbsp;&nbsp; folks: **1,720**  &nbsp;&nbsp; `1,816 stars this month`
