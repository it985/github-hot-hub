...
1. [iperov / DeepFaceLive](https://github.com/iperov/DeepFaceLive)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **9,020** &nbsp;&nbsp; folks: **1,263**  &nbsp;&nbsp; `122 stars today`

1. [calcom / cal.com](https://github.com/calcom/cal.com)
    - Scheduling infrastructure for absolutely everyone.
    - language: **TypeScript** &nbsp;&nbsp; stars: **15,578** &nbsp;&nbsp; folks: **1,870**  &nbsp;&nbsp; `39 stars today`

1. [openai / openai-cookbook](https://github.com/openai/openai-cookbook)
    - Examples and guides for using the OpenAI API
    - language: **Python** &nbsp;&nbsp; stars: **9,495** &nbsp;&nbsp; folks: **921**  &nbsp;&nbsp; `232 stars today`

1. [AcademySoftwareFoundation / xstudio](https://github.com/AcademySoftwareFoundation/xstudio)
    - 无
    - language: **C++** &nbsp;&nbsp; stars: **283** &nbsp;&nbsp; folks: **27**  &nbsp;&nbsp; `48 stars today`

1. [facebook / folly](https://github.com/facebook/folly)
    - An open-source C++ library developed and used at Facebook.
    - language: **C++** &nbsp;&nbsp; stars: **24,568** &nbsp;&nbsp; folks: **5,014**  &nbsp;&nbsp; `124 stars today`
...
1. [rocketseat-education / nlw-setup-ignite](https://github.com/rocketseat-education/nlw-setup-ignite)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **379** &nbsp;&nbsp; folks: **198**  &nbsp;&nbsp; `45 stars today`
...
1. [HorrorPills / ChatGPT-Gnome-Desktop-Extension](https://github.com/HorrorPills/ChatGPT-Gnome-Desktop-Extension)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **290** &nbsp;&nbsp; folks: **20**  &nbsp;&nbsp; `43 stars today`
...
1. [DovAmir / awesome-design-patterns](https://github.com/DovAmir/awesome-design-patterns)
    ...
    - language: **无** &nbsp;&nbsp; stars: **25,911** &nbsp;&nbsp; folks: **2,117**  &nbsp;&nbsp; `376 stars today`
...
1. [microsoft / AI-For-Beginners](https://github.com/microsoft/AI-For-Beginners)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **4,461** &nbsp;&nbsp; folks: **816**  &nbsp;&nbsp; `1,272 stars this week`
...
1. [nuxt / nuxt](https://github.com/nuxt/nuxt)
    - Nuxt is an intuitive and extendable way to create type-safe, performant and production-grade full-stack web apps and websites with Vue 3.
    - language: **TypeScript** &nbsp;&nbsp; stars: **42,016** &nbsp;&nbsp; folks: **3,335**  &nbsp;&nbsp; `222 stars this week`

1. [Dimillian / IceCubesApp](https://github.com/Dimillian/IceCubesApp)
    - A SwiftUI Mastodon client
    - language: **Swift** &nbsp;&nbsp; stars: **1,141** &nbsp;&nbsp; folks: **80**  &nbsp;&nbsp; `485 stars this week`
...
1. [gofireflyio / aiac](https://github.com/gofireflyio/aiac)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **898** &nbsp;&nbsp; folks: **57**  &nbsp;&nbsp; `221 stars this week`
...
1. [ai-collection / ai-collection](https://github.com/ai-collection/ai-collection)
    ...
    - language: **无** &nbsp;&nbsp; stars: **1,596** &nbsp;&nbsp; folks: **71**  &nbsp;&nbsp; `1,201 stars this week`
...
1. [lencx / ChatGPT](https://github.com/lencx/ChatGPT)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **5,675** &nbsp;&nbsp; folks: **414**  &nbsp;&nbsp; `4,676 stars this month`
...
1. [openai / openai-cookbook](https://github.com/openai/openai-cookbook)
    - Examples and guides for using the OpenAI API
    - language: **Python** &nbsp;&nbsp; stars: **9,495** &nbsp;&nbsp; folks: **921**  &nbsp;&nbsp; `6,752 stars this month`

1. [google / comprehensive-rust](https://github.com/google/comprehensive-rust)
    - This is the Rust course used by the Android team at Google. It provides you the material to quickly teach Rust to everyone.
    - language: **Rust** &nbsp;&nbsp; stars: **6,887** &nbsp;&nbsp; folks: **305**  &nbsp;&nbsp; `6,266 stars this month`
...
1. [f / awesome-chatgpt-prompts](https://github.com/f/awesome-chatgpt-prompts)
    ...
    - language: **HTML** &nbsp;&nbsp; stars: **17,205** &nbsp;&nbsp; folks: **1,484**  &nbsp;&nbsp; `8,247 stars this month`
...
1. [microsoft / Web-Dev-For-Beginners](https://github.com/microsoft/Web-Dev-For-Beginners)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **64,697** &nbsp;&nbsp; folks: **10,081**  &nbsp;&nbsp; `3,407 stars this month`

1. [facebook / folly](https://github.com/facebook/folly)
    - An open-source C++ library developed and used at Facebook.
    - language: **C++** &nbsp;&nbsp; stars: **24,568** &nbsp;&nbsp; folks: **5,014**  &nbsp;&nbsp; `679 stars this month`
