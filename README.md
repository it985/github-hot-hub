...
`更新时间：2023-02-01 01:14:12 +0800`

## 今日热门仓库

1. [fathyb / carbonyl](https://github.com/fathyb/carbonyl)
    - Chromium running inside your terminal
    - language: **Rust** &nbsp;&nbsp; stars: **6,246** &nbsp;&nbsp; folks: **146**  &nbsp;&nbsp; `1,534 stars today`

1. [localsend / localsend](https://github.com/localsend/localsend)
    - An open source cross-platform alternative to AirDrop
    - language: **Dart** &nbsp;&nbsp; stars: **3,445** &nbsp;&nbsp; folks: **165**  &nbsp;&nbsp; `1,133 stars today`

1. [bregman-arie / devops-exercises](https://github.com/bregman-arie/devops-exercises)
    - Linux, Jenkins, AWS, SRE, Prometheus, Docker, Python, Ansible, Git, Kubernetes, Terraform, OpenStack, SQL, NoSQL, Azure, GCP, DNS, Elastic, Network, Virtualization. DevOps Interview Questions
    - language: **Python** &nbsp;&nbsp; stars: **38,134** &nbsp;&nbsp; folks: **8,503**  &nbsp;&nbsp; `638 stars today`
...
1. [codecrafters-io / build-your-own-x](https://github.com/codecrafters-io/build-your-own-x)
    ...
    - language: **无** &nbsp;&nbsp; stars: **186,326** &nbsp;&nbsp; folks: **17,933**  &nbsp;&nbsp; `272 stars today`

1. [AzeemIdrisi / PhoneSploit-Pro](https://github.com/AzeemIdrisi/PhoneSploit-Pro)
    - An all-in-one hacking tool to remotely exploit Android devices using ADB and Metasploit-Framework to get a Meterpreter session.
    - language: **Python** &nbsp;&nbsp; stars: **2,111** &nbsp;&nbsp; folks: **309**  &nbsp;&nbsp; `618 stars today`

1. [Snailclimb / JavaGuide](https://github.com/Snailclimb/JavaGuide)
    - 「Java学习+面试指南」一份涵盖大部分 Java 程序员所需要掌握的核心知识。准备 Java 面试，首选 JavaGuide！
    - language: **Java** &nbsp;&nbsp; stars: **130,283** &nbsp;&nbsp; folks: **43,184**  &nbsp;&nbsp; `68 stars today`
...
1. [LAION-AI / Open-Assistant](https://github.com/LAION-AI/Open-Assistant)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **6,483** &nbsp;&nbsp; folks: **572**  &nbsp;&nbsp; `534 stars today`
...
1. [trekhleb / javascript-algorithms](https://github.com/trekhleb/javascript-algorithms)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **162,091** &nbsp;&nbsp; folks: **26,809**  &nbsp;&nbsp; `2,662 stars this week`

1. [brycedrennan / imaginAIry](https://github.com/brycedrennan/imaginAIry)
    - AI imagined images. Pythonic generation of stable diffusion images.
    - language: **Python** &nbsp;&nbsp; stars: **5,991** &nbsp;&nbsp; folks: **262**  &nbsp;&nbsp; `2,210 stars this week`

1. [bregman-arie / devops-exercises](https://github.com/bregman-arie/devops-exercises)
    - Linux, Jenkins, AWS, SRE, Prometheus, Docker, Python, Ansible, Git, Kubernetes, Terraform, OpenStack, SQL, NoSQL, Azure, GCP, DNS, Elastic, Network, Virtualization. DevOps Interview Questions
    - language: **Python** &nbsp;&nbsp; stars: **38,134** &nbsp;&nbsp; folks: **8,503**  &nbsp;&nbsp; `2,405 stars this week`

1. [LazyVim / LazyVim](https://github.com/LazyVim/LazyVim)
    - Neovim config for the lazy
    - language: **Lua** &nbsp;&nbsp; stars: **2,907** &nbsp;&nbsp; folks: **171**  &nbsp;&nbsp; `1,295 stars this week`

1. [nuxt / nuxt](https://github.com/nuxt/nuxt)
    - Nuxt is an intuitive and extendable way to create type-safe, performant and production-grade full-stack web apps and websites with Vue 3.
    - language: **TypeScript** &nbsp;&nbsp; stars: **43,054** &nbsp;&nbsp; folks: **3,421**  &nbsp;&nbsp; `671 stars this week`
...
1. [google-research / tuning_playbook](https://github.com/google-research/tuning_playbook)
    ...
    - language: **无** &nbsp;&nbsp; stars: **13,156** &nbsp;&nbsp; folks: **924**  &nbsp;&nbsp; `2,934 stars this week`

1. [karpathy / nn-zero-to-hero](https://github.com/karpathy/nn-zero-to-hero)
    - Neural Networks: Zero to Hero
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **5,821** &nbsp;&nbsp; folks: **480**  &nbsp;&nbsp; `1,493 stars this week`

1. [tiann / KernelSU](https://github.com/tiann/KernelSU)
    - A Kernel based root solution for Android
    - language: **C** &nbsp;&nbsp; stars: **1,163** &nbsp;&nbsp; folks: **176**  &nbsp;&nbsp; `255 stars this week`
...
1. [ranaroussi / yfinance](https://github.com/ranaroussi/yfinance)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **8,772** &nbsp;&nbsp; folks: **1,799**  &nbsp;&nbsp; `221 stars this week`

1. [MystenLabs / sui](https://github.com/MystenLabs/sui)
    - Sui, a next-generation smart contract platform with high throughput, low latency, and an asset-oriented programming model powered by the Move programming language
    - language: **Rust** &nbsp;&nbsp; stars: **3,398** &nbsp;&nbsp; folks: **8,036**  &nbsp;&nbsp; `194 stars this week`

1. [jlevy / the-art-of-command-line](https://github.com/jlevy/the-art-of-command-line)
    - Master the command line, in one page
    - language: **无** &nbsp;&nbsp; stars: **127,744** &nbsp;&nbsp; folks: **12,899**  &nbsp;&nbsp; `1,354 stars this week`
...
1. [resendlabs / react-email](https://github.com/resendlabs/react-email)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,131** &nbsp;&nbsp; folks: **133**  &nbsp;&nbsp; `800 stars this week`

1. [bradtraversy / 50projects50days](https://github.com/bradtraversy/50projects50days)
    - 50+ mini web projects using HTML, CSS & JS
    - language: **CSS** &nbsp;&nbsp; stars: **25,258** &nbsp;&nbsp; folks: **6,705**  &nbsp;&nbsp; `544 stars this week`
...
1. [flutter / samples](https://github.com/flutter/samples)
    ...
    - language: **Dart** &nbsp;&nbsp; stars: **14,329** &nbsp;&nbsp; folks: **6,584**  &nbsp;&nbsp; `151 stars this week`
...
1. [brycedrennan / imaginAIry](https://github.com/brycedrennan/imaginAIry)
    - AI imagined images. Pythonic generation of stable diffusion images.
    - language: **Python** &nbsp;&nbsp; stars: **5,991** &nbsp;&nbsp; folks: **262**  &nbsp;&nbsp; `4,457 stars this month`
...
1. [hwchase17 / langchain](https://github.com/hwchase17/langchain)
    - ⚡ Building applications with LLMs through composability ⚡
    - language: **Python** &nbsp;&nbsp; stars: **5,178** &nbsp;&nbsp; folks: **407**  &nbsp;&nbsp; `3,746 stars this month`

1. [nuxt / nuxt](https://github.com/nuxt/nuxt)
    - Nuxt is an intuitive and extendable way to create type-safe, performant and production-grade full-stack web apps and websites with Vue 3.
    - language: **TypeScript** &nbsp;&nbsp; stars: **43,054** &nbsp;&nbsp; folks: **3,421**  &nbsp;&nbsp; `1,407 stars this month`

1. [karpathy / nn-zero-to-hero](https://github.com/karpathy/nn-zero-to-hero)
    - Neural Networks: Zero to Hero
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **5,821** &nbsp;&nbsp; folks: **480**  &nbsp;&nbsp; `2,049 stars this month`

1. [LAION-AI / Open-Assistant](https://github.com/LAION-AI/Open-Assistant)
    - OpenAssistant is a chat-based assistant that understands tasks, can interact with third-party systems, and retrieve information dynamically to do so.
    - language: **Python** &nbsp;&nbsp; stars: **6,483** &nbsp;&nbsp; folks: **572**  &nbsp;&nbsp; `4,446 stars this month`
...
1. [neonbjb / tortoise-tts](https://github.com/neonbjb/tortoise-tts)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **3,806** &nbsp;&nbsp; folks: **394**  &nbsp;&nbsp; `1,780 stars this month`
...
1. [google / comprehensive-rust](https://github.com/google/comprehensive-rust)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **8,790** &nbsp;&nbsp; folks: **388**  &nbsp;&nbsp; `4,287 stars this month`
...
1. [resendlabs / react-email](https://github.com/resendlabs/react-email)
    - 💌 Build and send emails using React
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,131** &nbsp;&nbsp; folks: **133**  &nbsp;&nbsp; `1,965 stars this month`
