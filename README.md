...
1. [TelegramMessenger / Telegram-iOS](https://github.com/TelegramMessenger/Telegram-iOS)
    - Telegram-iOS
    - language: **Swift** &nbsp;&nbsp; stars: **5,763** &nbsp;&nbsp; folks: **1,549**  &nbsp;&nbsp; `16 stars today`
...
1. [XTLS / Xray-core](https://github.com/XTLS/Xray-core)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **23,958** &nbsp;&nbsp; folks: **3,773**  &nbsp;&nbsp; `24 stars today`

1. [telegramdesktop / tdesktop](https://github.com/telegramdesktop/tdesktop)
    - Telegram Desktop messaging app
    - language: **C++** &nbsp;&nbsp; stars: **25,674** &nbsp;&nbsp; folks: **5,081**  &nbsp;&nbsp; `49 stars today`

1. [bunkerity / bunkerweb](https://github.com/bunkerity/bunkerweb)
    - 🛡️ Open-source and next-generation Web Application Firewall (WAF)
    - language: **Python** &nbsp;&nbsp; stars: **5,853** &nbsp;&nbsp; folks: **329**  &nbsp;&nbsp; `62 stars today`
...
1. [Lightning-AI / LitServe](https://github.com/Lightning-AI/LitServe)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **1,086** &nbsp;&nbsp; folks: **58**  &nbsp;&nbsp; `349 stars today`
...
1. [microsoft / generative-ai-for-beginners](https://github.com/microsoft/generative-ai-for-beginners)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **61,292** &nbsp;&nbsp; folks: **30,992**  &nbsp;&nbsp; `2,419 stars this week`

1. [astral-sh / uv](https://github.com/astral-sh/uv)
    - An extremely fast Python package and project manager, written in Rust.
    - language: **Rust** &nbsp;&nbsp; stars: **18,100** &nbsp;&nbsp; folks: **527**  &nbsp;&nbsp; `1,971 stars this week`
...
1. [nikitabobko / AeroSpace](https://github.com/nikitabobko/AeroSpace)
    ...
    - language: **Swift** &nbsp;&nbsp; stars: **4,968** &nbsp;&nbsp; folks: **75**  &nbsp;&nbsp; `323 stars this week`
...
1. [rustdesk / rustdesk](https://github.com/rustdesk/rustdesk)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **71,270** &nbsp;&nbsp; folks: **8,198**  &nbsp;&nbsp; `527 stars this week`
...
1. [opendatalab / MinerU](https://github.com/opendatalab/MinerU)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **10,047** &nbsp;&nbsp; folks: **738**  &nbsp;&nbsp; `8,365 stars this month`

1. [sickcodes / Docker-OSX](https://github.com/sickcodes/Docker-OSX)
    - Run macOS VM in a Docker! Run near native OSX-KVM in Docker! X11 Forwarding! CI/CD for OS X Security Research! Docker mac Containers.
    - language: **Shell** &nbsp;&nbsp; stars: **40,432** &nbsp;&nbsp; folks: **1,929**  &nbsp;&nbsp; `4,200 stars this month`

1. [drawdb-io / drawdb](https://github.com/drawdb-io/drawdb)
    - Free, simple, and intuitive online database design tool and SQL generator.
    - language: **JavaScript** &nbsp;&nbsp; stars: **19,442** &nbsp;&nbsp; folks: **1,341**  &nbsp;&nbsp; `6,293 stars this month`
...
1. [comfyanonymous / ComfyUI](https://github.com/comfyanonymous/ComfyUI)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **48,367** &nbsp;&nbsp; folks: **5,074**  &nbsp;&nbsp; `5,136 stars this month`
...
1. [chen08209 / FlClash](https://github.com/chen08209/FlClash)
    - A multi-platform proxy client based on ClashMeta,simple and easy to use, open-source and ad-free.
    - language: **Dart** &nbsp;&nbsp; stars: **6,873** &nbsp;&nbsp; folks: **394**  &nbsp;&nbsp; `3,977 stars this month`
...
1. [jagrosh / MusicBot](https://github.com/jagrosh/MusicBot)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **5,159** &nbsp;&nbsp; folks: **2,495**  &nbsp;&nbsp; `238 stars this month`

1. [infiniflow / ragflow](https://github.com/infiniflow/ragflow)
    - RAGFlow is an open-source RAG (Retrieval-Augmented Generation) engine based on deep document understanding.
    - language: **Python** &nbsp;&nbsp; stars: **15,511** &nbsp;&nbsp; folks: **1,574**  &nbsp;&nbsp; `2,849 stars this month`
...
1. [miurla / morphic](https://github.com/miurla/morphic)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,689** &nbsp;&nbsp; folks: **1,394**  &nbsp;&nbsp; `568 stars this month`

1. [freqtrade / freqtrade](https://github.com/freqtrade/freqtrade)
    - Free, open source crypto trading bot
    - language: **Python** &nbsp;&nbsp; stars: **27,863** &nbsp;&nbsp; folks: **5,956**  &nbsp;&nbsp; `1,263 stars this month`
...
1. [MHSanaei / 3x-ui](https://github.com/MHSanaei/3x-ui)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **10,859** &nbsp;&nbsp; folks: **2,318**  &nbsp;&nbsp; `1,375 stars this month`
