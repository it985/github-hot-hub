...
1. [facebookresearch / segment-anything](https://github.com/facebookresearch/segment-anything)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **17,425** &nbsp;&nbsp; folks: **1,527**  &nbsp;&nbsp; `6,044 stars today`
...
1. [Torantulino / Auto-GPT](https://github.com/Torantulino/Auto-GPT)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **15,966** &nbsp;&nbsp; folks: **1,837**  &nbsp;&nbsp; `2,873 stars today`

1. [yoheinakajima / babyagi](https://github.com/yoheinakajima/babyagi)
    - 无
    - language: **Python** &nbsp;&nbsp; stars: **4,181** &nbsp;&nbsp; folks: **519**  &nbsp;&nbsp; `982 stars today`

1. [project-baize / baize-chatbot](https://github.com/project-baize/baize-chatbot)
    - Let ChatGPT teach your own chatbot in hours with a single GPU!
    - language: **Python** &nbsp;&nbsp; stars: **1,573** &nbsp;&nbsp; folks: **121**  &nbsp;&nbsp; `374 stars today`
...
1. [VideoCrafter / VideoCrafter](https://github.com/VideoCrafter/VideoCrafter)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **680** &nbsp;&nbsp; folks: **37**  &nbsp;&nbsp; `119 stars today`

1. [microsoft / JARVIS](https://github.com/microsoft/JARVIS)
    - JARVIS, a system to connect LLMs with ML community. Paper: https://arxiv.org/pdf/2303.17580.pdf
    - language: **Python** &nbsp;&nbsp; stars: **11,869** &nbsp;&nbsp; folks: **756**  &nbsp;&nbsp; `2,215 stars today`
...
1. [slint-ui / slint](https://github.com/slint-ui/slint)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **7,162** &nbsp;&nbsp; folks: **219**  &nbsp;&nbsp; `150 stars today`

1. [young-geng / EasyLM](https://github.com/young-geng/EasyLM)
    - Large language models (LLMs) made easy, EasyLM is a one stop solution for pre-training, finetuning, evaluating and serving LLMs in JAX/Flax.
    - language: **Python** &nbsp;&nbsp; stars: **508** &nbsp;&nbsp; folks: **39**  &nbsp;&nbsp; `82 stars today`
...
1. [nomic-ai / gpt4all](https://github.com/nomic-ai/gpt4all)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **24,686** &nbsp;&nbsp; folks: **2,517**  &nbsp;&nbsp; `10,815 stars this week`

1. [Yidadaa / ChatGPT-Next-Web](https://github.com/Yidadaa/ChatGPT-Next-Web)
    - One-Click to deploy well-designed ChatGPT web UI on Vercel. 一键拥有你自己的 ChatGPT 网页服务。
    - language: **TypeScript** &nbsp;&nbsp; stars: **13,208** &nbsp;&nbsp; folks: **6,145**  &nbsp;&nbsp; `6,412 stars this week`
...
1. [binary-husky / chatgpt_academic](https://github.com/binary-husky/chatgpt_academic)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **23,594** &nbsp;&nbsp; folks: **2,592**  &nbsp;&nbsp; `7,978 stars this week`
...
1. [ZrrSkywalker / LLaMA-Adapter](https://github.com/ZrrSkywalker/LLaMA-Adapter)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **2,015** &nbsp;&nbsp; folks: **120**  &nbsp;&nbsp; `885 stars this week`
...
1. [huggingface / transformers](https://github.com/huggingface/transformers)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **91,203** &nbsp;&nbsp; folks: **19,335**  &nbsp;&nbsp; `2,176 stars this week`
...
1. [Chanzhaoyu / chatgpt-web](https://github.com/Chanzhaoyu/chatgpt-web)
    ...
    - language: **Vue** &nbsp;&nbsp; stars: **15,588** &nbsp;&nbsp; folks: **5,221**  &nbsp;&nbsp; `10,871 stars this month`

1. [yetone / openai-translator](https://github.com/yetone/openai-translator)
    - 基于 ChatGPT API 的划词翻译浏览器插件和跨平台桌面端应用 - Browser extension and cross-platform desktop application for translation based on ChatGPT API.
    - language: **TypeScript** &nbsp;&nbsp; stars: **14,011** &nbsp;&nbsp; folks: **927**  &nbsp;&nbsp; `12,407 stars this month`
...
1. [openai / openai-cookbook](https://github.com/openai/openai-cookbook)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **26,378** &nbsp;&nbsp; folks: **3,747**  &nbsp;&nbsp; `10,006 stars this month`
...
1. [huggingface / peft](https://github.com/huggingface/peft)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **3,404** &nbsp;&nbsp; folks: **218**  &nbsp;&nbsp; `2,218 stars this month`
...
1. [facebookresearch / llama](https://github.com/facebookresearch/llama)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **16,990** &nbsp;&nbsp; folks: **2,692**  &nbsp;&nbsp; `8,619 stars this month`
...
1. [dair-ai / Prompt-Engineering-Guide](https://github.com/dair-ai/Prompt-Engineering-Guide)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **22,945** &nbsp;&nbsp; folks: **1,829**  &nbsp;&nbsp; `10,763 stars this month`

1. [huggingface / transformers](https://github.com/huggingface/transformers)
    - 🤗 Transformers: State-of-the-art Machine Learning for Pytorch, TensorFlow, and JAX.
    - language: **Python** &nbsp;&nbsp; stars: **91,203** &nbsp;&nbsp; folks: **19,335**  &nbsp;&nbsp; `7,447 stars this month`
