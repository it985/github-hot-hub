...
`更新时间：2025-02-05 02:24:25 +0800`

## 今日热门仓库

1. [oumi-ai / oumi](https://github.com/oumi-ai/oumi)
    - Everything you need to build state-of-the-art foundation models, end-to-end.
    - language: **Python** &nbsp;&nbsp; stars: **4,811** &nbsp;&nbsp; folks: **316**  &nbsp;&nbsp; `1,426 stars today`
...
1. [is-a-dev / register](https://github.com/is-a-dev/register)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **5,187** &nbsp;&nbsp; folks: **9,679**  &nbsp;&nbsp; `289 stars today`
...
1. [documenso / documenso](https://github.com/documenso/documenso)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **9,989** &nbsp;&nbsp; folks: **1,390**  &nbsp;&nbsp; `195 stars today`

1. [penpot / penpot](https://github.com/penpot/penpot)
    - Penpot: The open-source design tool for design and code collaboration
    - language: **Clojure** &nbsp;&nbsp; stars: **35,904** &nbsp;&nbsp; folks: **1,822**  &nbsp;&nbsp; `307 stars today`

1. [lobehub / lobe-chat](https://github.com/lobehub/lobe-chat)
    - 🤯 Lobe Chat - an open-source, modern-design AI chat framework. Supports Multi AI Providers( OpenAI / Claude 3 / Gemini / Ollama / Qwen / DeepSeek), Knowledge Base (file upload / knowledge management / RAG ), Multi-Modals (Vision/TTS/Plugins/Artifacts). One-click FREE deployment of your private ChatGPT/ Claude application.
    - language: **TypeScript** &nbsp;&nbsp; stars: **53,002** &nbsp;&nbsp; folks: **11,440**  &nbsp;&nbsp; `273 stars today`
...
1. [ocrmypdf / OCRmyPDF](https://github.com/ocrmypdf/OCRmyPDF)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **15,402** &nbsp;&nbsp; folks: **1,095**  &nbsp;&nbsp; `107 stars today`

1. [folke / snacks.nvim](https://github.com/folke/snacks.nvim)
    - 🍿 A collection of QoL plugins for Neovim
    - language: **Lua** &nbsp;&nbsp; stars: **3,127** &nbsp;&nbsp; folks: **111**  &nbsp;&nbsp; `68 stars today`
...
1. [ToolJet / ToolJet](https://github.com/ToolJet/ToolJet)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **34,381** &nbsp;&nbsp; folks: **4,413**  &nbsp;&nbsp; `248 stars today`
...
1. [ollama / ollama](https://github.com/ollama/ollama)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **118,791** &nbsp;&nbsp; folks: **9,504**  &nbsp;&nbsp; `7,094 stars this week`
...
1. [open-webui / open-webui](https://github.com/open-webui/open-webui)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **66,947** &nbsp;&nbsp; folks: **7,939**  &nbsp;&nbsp; `5,970 stars this week`
...
1. [QwenLM / Qwen2.5](https://github.com/QwenLM/Qwen2.5)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **14,742** &nbsp;&nbsp; folks: **983**  &nbsp;&nbsp; `2,612 stars this week`
...
1. [is-a-dev / register](https://github.com/is-a-dev/register)
    - Grab your own sweet-looking '.is-a.dev' subdomain.
    - language: **JavaScript** &nbsp;&nbsp; stars: **5,187** &nbsp;&nbsp; folks: **9,679**  &nbsp;&nbsp; `518 stars this week`
...
1. [browser-use / browser-use](https://github.com/browser-use/browser-use)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **23,875** &nbsp;&nbsp; folks: **2,360**  &nbsp;&nbsp; `14,810 stars this month`
...
1. [ollama / ollama](https://github.com/ollama/ollama)
    - Get up and running with Llama 3.3, DeepSeek-R1, Phi-4, Gemma 2, and other large language models.
    - language: **Go** &nbsp;&nbsp; stars: **118,791** &nbsp;&nbsp; folks: **9,504**  &nbsp;&nbsp; `12,925 stars this month`
...
1. [maybe-finance / maybe](https://github.com/maybe-finance/maybe)
    ...
    - language: **Ruby** &nbsp;&nbsp; stars: **38,736** &nbsp;&nbsp; folks: **2,748**  &nbsp;&nbsp; `3,928 stars this month`

1. [open-webui / open-webui](https://github.com/open-webui/open-webui)
    - User-friendly AI Interface (Supports Ollama, OpenAI API, ...)
    - language: **JavaScript** &nbsp;&nbsp; stars: **66,947** &nbsp;&nbsp; folks: **7,939**  &nbsp;&nbsp; `12,192 stars this month`
