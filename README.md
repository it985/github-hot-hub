...
1. [topoteretes / cognee](https://github.com/topoteretes/cognee)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **4,856** &nbsp;&nbsp; folks: **370**  &nbsp;&nbsp; `414 stars today`

1. [eyaltoledano / claude-task-master](https://github.com/eyaltoledano/claude-task-master)
    - An AI-powered task-management system you can drop into Cursor, Lovable, Windsurf, Roo, and others.
    - language: **JavaScript** &nbsp;&nbsp; stars: **13,158** &nbsp;&nbsp; folks: **1,378**  &nbsp;&nbsp; `332 stars today`
...
1. [LizardByte / Sunshine](https://github.com/LizardByte/Sunshine)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **26,173** &nbsp;&nbsp; folks: **1,242**  &nbsp;&nbsp; `37 stars today`

1. [friuns2 / BlackFriday-GPTs-Prompts](https://github.com/friuns2/BlackFriday-GPTs-Prompts)
    - List of free GPTs that doesn't require plus subscription
    - language: **无** &nbsp;&nbsp; stars: **7,307** &nbsp;&nbsp; folks: **1,095**  &nbsp;&nbsp; `286 stars today`
...
1. [onlook-dev / onlook](https://github.com/onlook-dev/onlook)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **17,641** &nbsp;&nbsp; folks: **1,096**  &nbsp;&nbsp; `7,285 stars this week`
...
1. [anthropics / prompt-eng-interactive-tutorial](https://github.com/anthropics/prompt-eng-interactive-tutorial)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **11,518** &nbsp;&nbsp; folks: **1,046**  &nbsp;&nbsp; `3,929 stars this week`

1. [tensorzero / tensorzero](https://github.com/tensorzero/tensorzero)
    - TensorZero creates a feedback loop for optimizing LLM applications — turning production data into smarter, faster, and cheaper models.
    - language: **Rust** &nbsp;&nbsp; stars: **5,811** &nbsp;&nbsp; folks: **362**  &nbsp;&nbsp; `475 stars this week`
...
1. [datawhalechina / self-llm](https://github.com/datawhalechina/self-llm)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **16,619** &nbsp;&nbsp; folks: **1,822**  &nbsp;&nbsp; `689 stars this week`
...
1. [donnemartin / system-design-primer](https://github.com/donnemartin/system-design-primer)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **305,046** &nbsp;&nbsp; folks: **50,444**  &nbsp;&nbsp; `3,059 stars this week`
...
1. [eyaltoledano / claude-task-master](https://github.com/eyaltoledano/claude-task-master)
    - An AI-powered task-management system you can drop into Cursor, Lovable, Windsurf, Roo, and others.
    - language: **JavaScript** &nbsp;&nbsp; stars: **13,158** &nbsp;&nbsp; folks: **1,378**  &nbsp;&nbsp; `1,583 stars this week`

1. [clash-verge-rev / clash-verge-rev](https://github.com/clash-verge-rev/clash-verge-rev)
    - A modern GUI client based on Tauri, designed to run in Windows, macOS and Linux for tailored proxy experience
    - language: **TypeScript** &nbsp;&nbsp; stars: **60,900** &nbsp;&nbsp; folks: **4,651**  &nbsp;&nbsp; `829 stars this week`
...
1. [onlook-dev / onlook](https://github.com/onlook-dev/onlook)
    - The Cursor for Designers • An Open-Source Visual Vibecoding Editor • Visually build, style, and edit your React App with AI
    - language: **TypeScript** &nbsp;&nbsp; stars: **17,641** &nbsp;&nbsp; folks: **1,096**  &nbsp;&nbsp; `8,165 stars this month`
...
1. [public-apis / public-apis](https://github.com/public-apis/public-apis)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **350,386** &nbsp;&nbsp; folks: **36,840**  &nbsp;&nbsp; `11,958 stars this month`
...
1. [virattt / ai-hedge-fund](https://github.com/virattt/ai-hedge-fund)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **35,295** &nbsp;&nbsp; folks: **6,134**  &nbsp;&nbsp; `8,296 stars this month`
