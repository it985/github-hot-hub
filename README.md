...
1. [TabbyML / tabby](https://github.com/TabbyML/tabby)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **24,558** &nbsp;&nbsp; folks: **1,119**  &nbsp;&nbsp; `1,210 stars today`

1. [kamranahmedse / developer-roadmap](https://github.com/kamranahmedse/developer-roadmap)
    - Interactive roadmaps, guides and other educational content to help developers grow in their careers.
    - language: **TypeScript** &nbsp;&nbsp; stars: **305,591** &nbsp;&nbsp; folks: **40,013**  &nbsp;&nbsp; `487 stars today`

1. [yt-dlp / yt-dlp](https://github.com/yt-dlp/yt-dlp)
    - A feature-rich command-line audio/video downloader
    - language: **Python** &nbsp;&nbsp; stars: **96,409** &nbsp;&nbsp; folks: **7,556**  &nbsp;&nbsp; `152 stars today`

1. [MagicMirrorOrg / MagicMirror](https://github.com/MagicMirrorOrg/MagicMirror)
    - MagicMirror² is an open source modular smart mirror platform. With a growing list of installable modules, the MagicMirror² allows you to convert your hallway or bathroom mirror into your personal assistant.
    - language: **JavaScript** &nbsp;&nbsp; stars: **20,697** &nbsp;&nbsp; folks: **4,265**  &nbsp;&nbsp; `296 stars today`
...
1. [automatisch / automatisch](https://github.com/automatisch/automatisch)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **7,136** &nbsp;&nbsp; folks: **516**  &nbsp;&nbsp; `61 stars today`
...
1. [mufeedvh / code2prompt](https://github.com/mufeedvh/code2prompt)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **3,208** &nbsp;&nbsp; folks: **196**  &nbsp;&nbsp; `177 stars today`
...
1. [78 / xiaozhi-esp32](https://github.com/78/xiaozhi-esp32)
    ...
    - language: **C** &nbsp;&nbsp; stars: **2,877** &nbsp;&nbsp; folks: **447**  &nbsp;&nbsp; `1,646 stars this week`
...
1. [NVIDIA / nv-ingest](https://github.com/NVIDIA/nv-ingest)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **1,849** &nbsp;&nbsp; folks: **161**  &nbsp;&nbsp; `1,152 stars this week`
...
1. [kamranahmedse / developer-roadmap](https://github.com/kamranahmedse/developer-roadmap)
    - Interactive roadmaps, guides and other educational content to help developers grow in their careers.
    - language: **TypeScript** &nbsp;&nbsp; stars: **305,591** &nbsp;&nbsp; folks: **40,013**  &nbsp;&nbsp; `1,582 stars this week`

1. [f / awesome-chatgpt-prompts](https://github.com/f/awesome-chatgpt-prompts)
    - This repo includes ChatGPT prompt curation to use ChatGPT and other LLM tools better.
    - language: **HTML** &nbsp;&nbsp; stars: **117,092** &nbsp;&nbsp; folks: **15,890**  &nbsp;&nbsp; `1,099 stars this week`
...
1. [imputnet / cobalt](https://github.com/imputnet/cobalt)
    ...
    - language: **Svelte** &nbsp;&nbsp; stars: **26,101** &nbsp;&nbsp; folks: **2,093**  &nbsp;&nbsp; `6,741 stars this month`
