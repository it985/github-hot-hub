...
1. [ggerganov / whisper.cpp](https://github.com/ggerganov/whisper.cpp)
    ...
    - language: **C** &nbsp;&nbsp; stars: **10,572** &nbsp;&nbsp; folks: **782**  &nbsp;&nbsp; `493 stars today`

1. [sindresorhus / awesome](https://github.com/sindresorhus/awesome)
    - 😎 Awesome lists about all kinds of interesting topics
    - language: **无** &nbsp;&nbsp; stars: **243,672** &nbsp;&nbsp; folks: **25,193**  &nbsp;&nbsp; `355 stars today`
...
1. [termux / termux-packages](https://github.com/termux/termux-packages)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **10,062** &nbsp;&nbsp; folks: **2,607**  &nbsp;&nbsp; `10 stars today`
...
1. [sherlock-project / sherlock](https://github.com/sherlock-project/sherlock)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **39,674** &nbsp;&nbsp; folks: **4,716**  &nbsp;&nbsp; `81 stars today`
...
1. [The-Art-of-Hacking / h4cker](https://github.com/The-Art-of-Hacking/h4cker)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **13,056** &nbsp;&nbsp; folks: **2,214**  &nbsp;&nbsp; `64 stars today`
...
1. [zauberzeug / nicegui](https://github.com/zauberzeug/nicegui)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **1,948** &nbsp;&nbsp; folks: **84**  &nbsp;&nbsp; `95 stars today`
...
1. [Chanzhaoyu / chatgpt-web](https://github.com/Chanzhaoyu/chatgpt-web)
    ...
    - language: **Vue** &nbsp;&nbsp; stars: **6,183** &nbsp;&nbsp; folks: **1,562**  &nbsp;&nbsp; `1,976 stars this week`

1. [ggerganov / whisper.cpp](https://github.com/ggerganov/whisper.cpp)
    - Port of OpenAI's Whisper model in C/C++
    - language: **C** &nbsp;&nbsp; stars: **10,572** &nbsp;&nbsp; folks: **782**  &nbsp;&nbsp; `2,849 stars this week`

1. [ServiceWeaver / weaver](https://github.com/ServiceWeaver/weaver)
    - Programming framework for writing and deploying cloud applications.
    - language: **Go** &nbsp;&nbsp; stars: **2,842** &nbsp;&nbsp; folks: **101**  &nbsp;&nbsp; `1,114 stars this week`

1. [facebookresearch / llama](https://github.com/facebookresearch/llama)
    - Inference code for LLaMA models
    - language: **Python** &nbsp;&nbsp; stars: **10,430** &nbsp;&nbsp; folks: **1,570**  &nbsp;&nbsp; `2,669 stars this week`
...
1. [sindresorhus / awesome](https://github.com/sindresorhus/awesome)
    - 😎 Awesome lists about all kinds of interesting topics
    - language: **无** &nbsp;&nbsp; stars: **243,672** &nbsp;&nbsp; folks: **25,193**  &nbsp;&nbsp; `2,167 stars this week`
...
1. [lvwerra / trl](https://github.com/lvwerra/trl)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **2,028** &nbsp;&nbsp; folks: **223**  &nbsp;&nbsp; `156 stars this week`

1. [jerryjliu / llama_index](https://github.com/jerryjliu/llama_index)
    - LlamaIndex (GPT Index) is a project that provides a central interface to connect your LLM's with external data.
    - language: **Python** &nbsp;&nbsp; stars: **6,524** &nbsp;&nbsp; folks: **589**  &nbsp;&nbsp; `1,057 stars this week`
...
1. [f / awesome-chatgpt-prompts](https://github.com/f/awesome-chatgpt-prompts)
    ...
    - language: **HTML** &nbsp;&nbsp; stars: **41,798** &nbsp;&nbsp; folks: **4,889**  &nbsp;&nbsp; `16,700 stars this month`
...
1. [yt-dlp / yt-dlp](https://github.com/yt-dlp/yt-dlp)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **42,781** &nbsp;&nbsp; folks: **3,514**  &nbsp;&nbsp; `3,512 stars this month`

1. [Asabeneh / 30-Days-Of-Python](https://github.com/Asabeneh/30-Days-Of-Python)
    - 30 days of Python programming challenge is a step-by-step guide to learn the Python programming language in 30 days. This challenge may take more than100 days, follow your own pace.
    - language: **Python** &nbsp;&nbsp; stars: **22,238** &nbsp;&nbsp; folks: **4,715**  &nbsp;&nbsp; `3,303 stars this month`
...
1. [ggerganov / whisper.cpp](https://github.com/ggerganov/whisper.cpp)
    - Port of OpenAI's Whisper model in C/C++
    - language: **C** &nbsp;&nbsp; stars: **10,572** &nbsp;&nbsp; folks: **782**  &nbsp;&nbsp; `3,963 stars this month`
...
1. [hwchase17 / langchain](https://github.com/hwchase17/langchain)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **10,868** &nbsp;&nbsp; folks: **967**  &nbsp;&nbsp; `4,372 stars this month`

1. [waylaidwanderer / node-chatgpt-api](https://github.com/waylaidwanderer/node-chatgpt-api)
    - A client implementation for ChatGPT and Bing AI. Available as a Node.js module, REST API server, and CLI app.
    - language: **JavaScript** &nbsp;&nbsp; stars: **2,137** &nbsp;&nbsp; folks: **310**  &nbsp;&nbsp; `1,017 stars this month`
...
1. [TheoKanning / openai-java](https://github.com/TheoKanning/openai-java)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **1,478** &nbsp;&nbsp; folks: **373**  &nbsp;&nbsp; `808 stars this month`
