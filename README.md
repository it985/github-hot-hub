...
`更新时间：2024-10-06 02:21:41 +0800`

## 今日热门仓库

1. [TheAlgorithms / Python](https://github.com/TheAlgorithms/Python)
    - All Algorithms implemented in Python
    - language: **Python** &nbsp;&nbsp; stars: **187,453** &nbsp;&nbsp; folks: **44,739**  &nbsp;&nbsp; `1,938 stars today`

1. [Pythagora-io / gpt-pilot](https://github.com/Pythagora-io/gpt-pilot)
    - The first real AI developer
    - language: **Python** &nbsp;&nbsp; stars: **30,732** &nbsp;&nbsp; folks: **3,080**  &nbsp;&nbsp; `158 stars today`

1. [ocornut / imgui](https://github.com/ocornut/imgui)
    - Dear ImGui: Bloat-free Graphical User interface for C++ with minimal dependencies
    - language: **C++** &nbsp;&nbsp; stars: **59,942** &nbsp;&nbsp; folks: **10,186**  &nbsp;&nbsp; `29 stars today`
...
1. [shardeum / shardeum](https://github.com/shardeum/shardeum)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **16,604** &nbsp;&nbsp; folks: **349**  &nbsp;&nbsp; `830 stars today`

1. [Avaiga / taipy](https://github.com/Avaiga/taipy)
    - Turns Data and AI algorithms into production-ready web applications in no time.
    - language: **Python** &nbsp;&nbsp; stars: **12,405** &nbsp;&nbsp; folks: **921**  &nbsp;&nbsp; `16 stars today`

1. [TheAlgorithms / Rust](https://github.com/TheAlgorithms/Rust)
    - All Algorithms implemented in Rust
    - language: **Rust** &nbsp;&nbsp; stars: **22,346** &nbsp;&nbsp; folks: **2,180**  &nbsp;&nbsp; `61 stars today`
...
1. [dair-ai / Prompt-Engineering-Guide](https://github.com/dair-ai/Prompt-Engineering-Guide)
    ...
    - language: **MDX** &nbsp;&nbsp; stars: **48,963** &nbsp;&nbsp; folks: **4,750**  &nbsp;&nbsp; `208 stars today`
...
1. [Budibase / budibase](https://github.com/Budibase/budibase)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **22,065** &nbsp;&nbsp; folks: **1,519**  &nbsp;&nbsp; `11 stars today`
...
1. [kestra-io / kestra](https://github.com/kestra-io/kestra)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **9,544** &nbsp;&nbsp; folks: **714**  &nbsp;&nbsp; `1,206 stars this week`
...
1. [OpenBB-finance / OpenBB](https://github.com/OpenBB-finance/OpenBB)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **31,616** &nbsp;&nbsp; folks: **2,889**  &nbsp;&nbsp; `1,213 stars this week`

1. [immich-app / immich](https://github.com/immich-app/immich)
    - High performance self-hosted photo and video management solution.
    - language: **TypeScript** &nbsp;&nbsp; stars: **47,318** &nbsp;&nbsp; folks: **2,396**  &nbsp;&nbsp; `1,496 stars this week`

1. [TheAlgorithms / Python](https://github.com/TheAlgorithms/Python)
    - All Algorithms implemented in Python
    - language: **Python** &nbsp;&nbsp; stars: **187,453** &nbsp;&nbsp; folks: **44,739**  &nbsp;&nbsp; `1,291 stars this week`
...
1. [microsoft / RD-Agent](https://github.com/microsoft/RD-Agent)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **778** &nbsp;&nbsp; folks: **56**  &nbsp;&nbsp; `373 stars this week`
...
1. [Pythagora-io / gpt-pilot](https://github.com/Pythagora-io/gpt-pilot)
    - The first real AI developer
    - language: **Python** &nbsp;&nbsp; stars: **30,732** &nbsp;&nbsp; folks: **3,080**  &nbsp;&nbsp; `622 stars this week`
...
1. [kestra-io / kestra](https://github.com/kestra-io/kestra)
    - ⚡ Open-source workflow automation platform. Orchestrate any language using YAML, hundreds of integrations. Alternative to Airflow, n8n, RunDeck, Camunda, Jenkins...
    - language: **Java** &nbsp;&nbsp; stars: **9,544** &nbsp;&nbsp; folks: **714**  &nbsp;&nbsp; `2,149 stars this month`
...
1. [anthropics / anthropic-cookbook](https://github.com/anthropics/anthropic-cookbook)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **5,895** &nbsp;&nbsp; folks: **688**  &nbsp;&nbsp; `1,586 stars this month`

1. [Zipstack / unstract](https://github.com/Zipstack/unstract)
    - No-code LLM Platform to launch APIs and ETL Pipelines to structure unstructured documents
    - language: **Python** &nbsp;&nbsp; stars: **2,255** &nbsp;&nbsp; folks: **126**  &nbsp;&nbsp; `1,333 stars this month`
...
1. [OpenBMB / MiniCPM](https://github.com/OpenBMB/MiniCPM)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **6,962** &nbsp;&nbsp; folks: **439**  &nbsp;&nbsp; `2,299 stars this month`
