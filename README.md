...
1. [TabbyML / tabby](https://github.com/TabbyML/tabby)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **24,518** &nbsp;&nbsp; folks: **1,118**  &nbsp;&nbsp; `1,210 stars today`

1. [kamranahmedse / developer-roadmap](https://github.com/kamranahmedse/developer-roadmap)
    - Interactive roadmaps, guides and other educational content to help developers grow in their careers.
    - language: **TypeScript** &nbsp;&nbsp; stars: **305,562** &nbsp;&nbsp; folks: **40,011**  &nbsp;&nbsp; `487 stars today`

1. [yt-dlp / yt-dlp](https://github.com/yt-dlp/yt-dlp)
    - A feature-rich command-line audio/video downloader
    - language: **Python** &nbsp;&nbsp; stars: **96,397** &nbsp;&nbsp; folks: **7,556**  &nbsp;&nbsp; `152 stars today`

1. [MagicMirrorOrg / MagicMirror](https://github.com/MagicMirrorOrg/MagicMirror)
    - MagicMirror² is an open source modular smart mirror platform. With a growing list of installable modules, the MagicMirror² allows you to convert your hallway or bathroom mirror into your personal assistant.
    - language: **JavaScript** &nbsp;&nbsp; stars: **20,686** &nbsp;&nbsp; folks: **4,265**  &nbsp;&nbsp; `296 stars today`
...
1. [JoshuaC215 / agent-service-toolkit](https://github.com/JoshuaC215/agent-service-toolkit)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **1,144** &nbsp;&nbsp; folks: **180**  &nbsp;&nbsp; `90 stars today`
...
1. [feder-cr / Jobs_Applier_AI_Agent](https://github.com/feder-cr/Jobs_Applier_AI_Agent)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **26,270** &nbsp;&nbsp; folks: **3,849**  &nbsp;&nbsp; `808 stars today`
...
1. [mufeedvh / code2prompt](https://github.com/mufeedvh/code2prompt)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **3,189** &nbsp;&nbsp; folks: **194**  &nbsp;&nbsp; `177 stars today`
...
1. [unclecode / crawl4ai](https://github.com/unclecode/crawl4ai)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **24,591** &nbsp;&nbsp; folks: **1,824**  &nbsp;&nbsp; `3,011 stars this week`
...
1. [All-Hands-AI / OpenHands](https://github.com/All-Hands-AI/OpenHands)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **43,260** &nbsp;&nbsp; folks: **4,786**  &nbsp;&nbsp; `2,496 stars this week`
...
1. [Canner / WrenAI](https://github.com/Canner/WrenAI)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,126** &nbsp;&nbsp; folks: **350**  &nbsp;&nbsp; `1,214 stars this week`

1. [mudler / LocalAI](https://github.com/mudler/LocalAI)
    - 🤖 The free, Open Source alternative to OpenAI, Claude and others. Self-hosted and local-first. Drop-in replacement for OpenAI, running on consumer-grade hardware. No GPU required. Runs gguf, transformers, diffusers and many more models architectures. Features: Generate Text, Audio, Video, Images, Voice Cloning, Distributed, P2P inference
    - language: **Go** &nbsp;&nbsp; stars: **28,365** &nbsp;&nbsp; folks: **2,132**  &nbsp;&nbsp; `784 stars this week`

1. [cline / cline](https://github.com/cline/cline)
    - Autonomous coding agent right in your IDE, capable of creating/editing files, executing commands, using the browser, and more with your permission every step of the way.
    - language: **TypeScript** &nbsp;&nbsp; stars: **22,038** &nbsp;&nbsp; folks: **1,897**  &nbsp;&nbsp; `2,409 stars this week`
...
1. [kamranahmedse / developer-roadmap](https://github.com/kamranahmedse/developer-roadmap)
    - Interactive roadmaps, guides and other educational content to help developers grow in their careers.
    - language: **TypeScript** &nbsp;&nbsp; stars: **305,562** &nbsp;&nbsp; folks: **40,011**  &nbsp;&nbsp; `1,582 stars this week`
...
1. [cline / cline](https://github.com/cline/cline)
    - Autonomous coding agent right in your IDE, capable of creating/editing files, executing commands, using the browser, and more with your permission every step of the way.
    - language: **TypeScript** &nbsp;&nbsp; stars: **22,038** &nbsp;&nbsp; folks: **1,897**  &nbsp;&nbsp; `7,483 stars this month`
...
1. [unclecode / crawl4ai](https://github.com/unclecode/crawl4ai)
    - 🚀🤖 Crawl4AI: Open-source LLM Friendly Web Crawler & Scraper
    - language: **Python** &nbsp;&nbsp; stars: **24,591** &nbsp;&nbsp; folks: **1,824**  &nbsp;&nbsp; `5,963 stars this month`
...
1. [All-Hands-AI / OpenHands](https://github.com/All-Hands-AI/OpenHands)
    - 🙌 OpenHands: Code Less, Make More
    - language: **Python** &nbsp;&nbsp; stars: **43,260** &nbsp;&nbsp; folks: **4,786**  &nbsp;&nbsp; `4,934 stars this month`
