...
`更新时间：2025-01-23 15:16:01 +0800`

## 今日热门仓库

1. [exo-explore / exo](https://github.com/exo-explore/exo)
    - Run your own AI cluster at home with everyday devices 📱💻 🖥️⌚
    - language: **Python** &nbsp;&nbsp; stars: **19,384** &nbsp;&nbsp; folks: **1,091**  &nbsp;&nbsp; `131 stars today`
...
1. [yorukot / superfile](https://github.com/yorukot/superfile)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **9,882** &nbsp;&nbsp; folks: **225**  &nbsp;&nbsp; `76 stars today`

1. [Dokploy / dokploy](https://github.com/Dokploy/dokploy)
    - Open Source Alternative to Vercel, Netlify and Heroku.
    - language: **TypeScript** &nbsp;&nbsp; stars: **14,835** &nbsp;&nbsp; folks: **760**  &nbsp;&nbsp; `564 stars today`

1. [shadps4-emu / shadPS4](https://github.com/shadps4-emu/shadPS4)
    - PlayStation 4 emulator for Windows, Linux and macOS written in C++
    - language: **C++** &nbsp;&nbsp; stars: **14,421** &nbsp;&nbsp; folks: **930**  &nbsp;&nbsp; `644 stars today`
...
1. [jingyaogong / minimind](https://github.com/jingyaogong/minimind)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **6,438** &nbsp;&nbsp; folks: **692**  &nbsp;&nbsp; `202 stars today`
...
1. [mudler / LocalAI](https://github.com/mudler/LocalAI)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **29,592** &nbsp;&nbsp; folks: **2,219**  &nbsp;&nbsp; `121 stars today`
...
1. [hacksider / Deep-Live-Cam](https://github.com/hacksider/Deep-Live-Cam)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **43,029** &nbsp;&nbsp; folks: **6,261**  &nbsp;&nbsp; `187 stars today`
...
1. [codecrafters-io / build-your-own-x](https://github.com/codecrafters-io/build-your-own-x)
    ...
    - language: **Markdown** &nbsp;&nbsp; stars: **327,694** &nbsp;&nbsp; folks: **30,360**  &nbsp;&nbsp; `540 stars today`

1. [DataExpert-io / data-engineer-handbook](https://github.com/DataExpert-io/data-engineer-handbook)
    - This is a repo with links to everything you'd ever want to learn about data engineering
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **25,077** &nbsp;&nbsp; folks: **4,886**  &nbsp;&nbsp; `57 stars today`
...
1. [Dokploy / dokploy](https://github.com/Dokploy/dokploy)
    - Open Source Alternative to Vercel, Netlify and Heroku.
    - language: **TypeScript** &nbsp;&nbsp; stars: **14,835** &nbsp;&nbsp; folks: **760**  &nbsp;&nbsp; `3,737 stars this week`
...
1. [jingyaogong / minimind](https://github.com/jingyaogong/minimind)
    - 🚀🚀 「大模型」3小时完全从0训练26M的小参数GPT！🌏 Train a 26M-parameter GPT from scratch in just 3 hours!
    - language: **Python** &nbsp;&nbsp; stars: **6,438** &nbsp;&nbsp; folks: **692**  &nbsp;&nbsp; `1,341 stars this week`
...
1. [jingyaogong / minimind](https://github.com/jingyaogong/minimind)
    - 🚀🚀 「大模型」3小时完全从0训练26M的小参数GPT！🌏 Train a 26M-parameter GPT from scratch in just 3 hours!
    - language: **Python** &nbsp;&nbsp; stars: **6,438** &nbsp;&nbsp; folks: **692**  &nbsp;&nbsp; `3,207 stars this month`
...
1. [n8n-io / n8n](https://github.com/n8n-io/n8n)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **56,086** &nbsp;&nbsp; folks: **10,527**  &nbsp;&nbsp; `4,120 stars this month`
