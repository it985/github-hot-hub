...
`更新时间：2024-12-23 12:21:16 +0800`

## 今日热门仓库

1. [nicbarker / clay](https://github.com/nicbarker/clay)
    - High performance UI layout library in C.
    - language: **C** &nbsp;&nbsp; stars: **5,728** &nbsp;&nbsp; folks: **154**  &nbsp;&nbsp; `1,544 stars today`

1. [donnemartin / system-design-primer](https://github.com/donnemartin/system-design-primer)
    - Learn how to design large-scale systems. Prep for the system design interview. Includes Anki flashcards.
    - language: **Python** &nbsp;&nbsp; stars: **281,271** &nbsp;&nbsp; folks: **47,070**  &nbsp;&nbsp; `418 stars today`

1. [Genesis-Embodied-AI / Genesis](https://github.com/Genesis-Embodied-AI/Genesis)
    - A generative world for general-purpose robotics & embodied AI learning.
    - language: **Python** &nbsp;&nbsp; stars: **17,866** &nbsp;&nbsp; folks: **1,264**  &nbsp;&nbsp; `1,337 stars today`
...
1. [bol-van / zapret](https://github.com/bol-van/zapret)
    ...
    - language: **C** &nbsp;&nbsp; stars: **9,105** &nbsp;&nbsp; folks: **680**  &nbsp;&nbsp; `92 stars today`

1. [bytedance / monolith](https://github.com/bytedance/monolith)
    - ByteDance's Recommendation System
    - language: **Python** &nbsp;&nbsp; stars: **3,176** &nbsp;&nbsp; folks: **295**  &nbsp;&nbsp; `306 stars today`
...
1. [anthropics / anthropic-cookbook](https://github.com/anthropics/anthropic-cookbook)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **7,860** &nbsp;&nbsp; folks: **980**  &nbsp;&nbsp; `196 stars today`
...
1. [Helicone / helicone](https://github.com/Helicone/helicone)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,630** &nbsp;&nbsp; folks: **279**  &nbsp;&nbsp; `26 stars today`
...
1. [browserbase / stagehand](https://github.com/browserbase/stagehand)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,134** &nbsp;&nbsp; folks: **87**  &nbsp;&nbsp; `116 stars today`
...
1. [anthropics / anthropic-cookbook](https://github.com/anthropics/anthropic-cookbook)
    - A collection of notebooks/recipes showcasing some fun and effective ways of using Claude.
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **7,860** &nbsp;&nbsp; folks: **980**  &nbsp;&nbsp; `458 stars this week`
