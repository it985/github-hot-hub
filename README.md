...
1. [Elfocrash / .NET-Backend-Developer-Roadmap](https://github.com/Elfocrash/.NET-Backend-Developer-Roadmap)
    ...
    - language: **无** &nbsp;&nbsp; stars: **4,334** &nbsp;&nbsp; folks: **355**  &nbsp;&nbsp; `88 stars today`
...
1. [drizzle-team / drizzle-orm](https://github.com/drizzle-team/drizzle-orm)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **1,684** &nbsp;&nbsp; folks: **23**  &nbsp;&nbsp; `119 stars today`
...
1. [autonomousvision / stylegan-t](https://github.com/autonomousvision/stylegan-t)
    ...
    - language: **无** &nbsp;&nbsp; stars: **692** &nbsp;&nbsp; folks: **21**  &nbsp;&nbsp; `26 stars today`

1. [ggerganov / whisper.cpp](https://github.com/ggerganov/whisper.cpp)
    - Port of OpenAI's Whisper model in C/C++
    - language: **C** &nbsp;&nbsp; stars: **9,617** &nbsp;&nbsp; folks: **696**  &nbsp;&nbsp; `437 stars today`
...
1. [mli / paper-reading](https://github.com/mli/paper-reading)
    - 深度学习经典、新论文逐段精读
    - language: **无** &nbsp;&nbsp; stars: **15,078** &nbsp;&nbsp; folks: **1,467**  &nbsp;&nbsp; `159 stars today`
...
1. [EddieHubCommunity / LinkFree](https://github.com/EddieHubCommunity/LinkFree)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **3,050** &nbsp;&nbsp; folks: **2,349**  &nbsp;&nbsp; `43 stars today`

1. [dotnet / maui](https://github.com/dotnet/maui)
    - .NET MAUI is the .NET Multi-platform App UI, a framework for building native device applications spanning mobile, tablet, and desktop.
    - language: **C#** &nbsp;&nbsp; stars: **18,544** &nbsp;&nbsp; folks: **1,245**  &nbsp;&nbsp; `54 stars today`
...
1. [sashabaranov / go-openai](https://github.com/sashabaranov/go-openai)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **1,662** &nbsp;&nbsp; folks: **225**  &nbsp;&nbsp; `573 stars this week`

1. [jerryjliu / gpt_index](https://github.com/jerryjliu/gpt_index)
    - LlamaIndex (GPT Index) is a project that provides a central interface to connect your LLM's with external data.
    - language: **Python** &nbsp;&nbsp; stars: **6,250** &nbsp;&nbsp; folks: **569**  &nbsp;&nbsp; `1,507 stars this week`
...
1. [mukulpatnaik / researchgpt](https://github.com/mukulpatnaik/researchgpt)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **1,947** &nbsp;&nbsp; folks: **168**  &nbsp;&nbsp; `910 stars this week`

1. [ggerganov / whisper.cpp](https://github.com/ggerganov/whisper.cpp)
    - Port of OpenAI's Whisper model in C/C++
    - language: **C** &nbsp;&nbsp; stars: **9,617** &nbsp;&nbsp; folks: **696**  &nbsp;&nbsp; `1,851 stars this week`

1. [honghuangdc / soybean-admin](https://github.com/honghuangdc/soybean-admin)
    - A fresh and elegant admin template, based on Vue3,Vite3,TypeScript,NaiveUI and UnoCSS [一个基于Vue3、Vite3、TypeScript、NaiveUI 和 UnoCSS的清新优雅的中后台模版]
    - language: **Vue** &nbsp;&nbsp; stars: **3,039** &nbsp;&nbsp; folks: **586**  &nbsp;&nbsp; `246 stars this week`

1. [sindresorhus / awesome](https://github.com/sindresorhus/awesome)
    - 😎 Awesome lists about all kinds of interesting topics
    - language: **无** &nbsp;&nbsp; stars: **242,999** &nbsp;&nbsp; folks: **25,144**  &nbsp;&nbsp; `1,668 stars this week`

1. [shadcn / taxonomy](https://github.com/shadcn/taxonomy)
    - An open source application built using the new router, server components and everything new in Next.js 13.
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,784** &nbsp;&nbsp; folks: **313**  &nbsp;&nbsp; `380 stars this week`
...
1. [hwchase17 / langchain](https://github.com/hwchase17/langchain)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **10,476** &nbsp;&nbsp; folks: **934**  &nbsp;&nbsp; `1,330 stars this week`
...
1. [whitead / paper-qa](https://github.com/whitead/paper-qa)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **1,355** &nbsp;&nbsp; folks: **87**  &nbsp;&nbsp; `449 stars this week`
...
1. [AUTOMATIC1111 / stable-diffusion-webui](https://github.com/AUTOMATIC1111/stable-diffusion-webui)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **46,519** &nbsp;&nbsp; folks: **8,617**  &nbsp;&nbsp; `14,659 stars this month`
...
1. [f / awesome-chatgpt-prompts](https://github.com/f/awesome-chatgpt-prompts)
    ...
    - language: **HTML** &nbsp;&nbsp; stars: **41,019** &nbsp;&nbsp; folks: **4,788**  &nbsp;&nbsp; `17,174 stars this month`
...
1. [PlexPt / awesome-chatgpt-prompts-zh](https://github.com/PlexPt/awesome-chatgpt-prompts-zh)
    ...
    - language: **无** &nbsp;&nbsp; stars: **13,801** &nbsp;&nbsp; folks: **4,680**  &nbsp;&nbsp; `8,309 stars this month`
...
1. [Asabeneh / 30-Days-Of-Python](https://github.com/Asabeneh/30-Days-Of-Python)
    - 30 days of Python programming challenge is a step-by-step guide to learn the Python programming language in 30 days. This challenge may take more than100 days, follow your own pace.
    - language: **Python** &nbsp;&nbsp; stars: **22,100** &nbsp;&nbsp; folks: **4,690**  &nbsp;&nbsp; `3,221 stars this month`
...
1. [ggerganov / whisper.cpp](https://github.com/ggerganov/whisper.cpp)
    - Port of OpenAI's Whisper model in C/C++
    - language: **C** &nbsp;&nbsp; stars: **9,617** &nbsp;&nbsp; folks: **696**  &nbsp;&nbsp; `3,164 stars this month`

1. [vlang / v](https://github.com/vlang/v)
    - Simple, fast, safe, compiled language for developing maintainable software. Compiles itself in <1s with zero library dependencies. Supports automatic C => V translation. https://vlang.io
    - language: **V** &nbsp;&nbsp; stars: **32,901** &nbsp;&nbsp; folks: **1,989**  &nbsp;&nbsp; `1,753 stars this month`

1. [hwchase17 / langchain](https://github.com/hwchase17/langchain)
    - ⚡ Building applications with LLMs through composability ⚡
    - language: **Python** &nbsp;&nbsp; stars: **10,476** &nbsp;&nbsp; folks: **934**  &nbsp;&nbsp; `4,155 stars this month`
