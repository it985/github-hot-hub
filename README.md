...
`更新时间：2025-01-05 02:22:38 +0800`

## 今日热门仓库

1. [stanford-oval / storm](https://github.com/stanford-oval/storm)
    - An LLM-powered knowledge curation system that researches a topic and generates a full-length report with citations.
    - language: **Python** &nbsp;&nbsp; stars: **16,231** &nbsp;&nbsp; folks: **1,493**  &nbsp;&nbsp; `1,367 stars today`
...
1. [alufers / mitmproxy2swagger](https://github.com/alufers/mitmproxy2swagger)
    ...
    - language: **HTML** &nbsp;&nbsp; stars: **7,776** &nbsp;&nbsp; folks: **282**  &nbsp;&nbsp; `479 stars today`

1. [gitroomhq / postiz-app](https://github.com/gitroomhq/postiz-app)
    - 📨 The ultimate social media scheduling tool, with a bunch of AI 🤖
    - language: **TypeScript** &nbsp;&nbsp; stars: **16,435** &nbsp;&nbsp; folks: **2,660**  &nbsp;&nbsp; `322 stars today`
...
1. [nvm-sh / nvm](https://github.com/nvm-sh/nvm)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **81,416** &nbsp;&nbsp; folks: **8,104**  &nbsp;&nbsp; `81 stars today`

1. [kyegomez / swarms](https://github.com/kyegomez/swarms)
    - The Enterprise-Grade Production-Ready Multi-Agent Orchestration Framework Join our Community: https://discord.com/servers/agora-999382051935506503
    - language: **Python** &nbsp;&nbsp; stars: **2,349** &nbsp;&nbsp; folks: **320**  &nbsp;&nbsp; `59 stars today`
...
1. [louis-e / arnis](https://github.com/louis-e/arnis)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **3,422** &nbsp;&nbsp; folks: **94**  &nbsp;&nbsp; `507 stars today`
...
1. [caddyserver / caddy](https://github.com/caddyserver/caddy)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **60,049** &nbsp;&nbsp; folks: **4,107**  &nbsp;&nbsp; `124 stars today`
...
1. [DrewThomasson / ebook2audiobook](https://github.com/DrewThomasson/ebook2audiobook)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **4,838** &nbsp;&nbsp; folks: **310**  &nbsp;&nbsp; `2,867 stars this week`
...
1. [stanford-oval / storm](https://github.com/stanford-oval/storm)
    - An LLM-powered knowledge curation system that researches a topic and generates a full-length report with citations.
    - language: **Python** &nbsp;&nbsp; stars: **16,231** &nbsp;&nbsp; folks: **1,493**  &nbsp;&nbsp; `1,149 stars this week`
...
1. [DrewThomasson / ebook2audiobook](https://github.com/DrewThomasson/ebook2audiobook)
    - Convert ebooks to audiobooks with chapters and metadata using dynamic AI models and voice cloning. Supports 1,107+ languages!
    - language: **Python** &nbsp;&nbsp; stars: **4,838** &nbsp;&nbsp; folks: **310**  &nbsp;&nbsp; `3,594 stars this month`
...
1. [cline / cline](https://github.com/cline/cline)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **18,970** &nbsp;&nbsp; folks: **1,583**  &nbsp;&nbsp; `5,468 stars this month`
