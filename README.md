...
`更新时间：2024-11-11 13:17:59 +0800`

## 今日热门仓库

1. [dockur / windows](https://github.com/dockur/windows)
    - Windows inside a Docker container.
    - language: **Shell** &nbsp;&nbsp; stars: **22,000** &nbsp;&nbsp; folks: **1,708**  &nbsp;&nbsp; `1,207 stars today`
...
1. [PrefectHQ / prefect](https://github.com/PrefectHQ/prefect)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **17,091** &nbsp;&nbsp; folks: **1,626**  &nbsp;&nbsp; `530 stars today`
...
1. [actualbudget / actual](https://github.com/actualbudget/actual)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **15,276** &nbsp;&nbsp; folks: **1,192**  &nbsp;&nbsp; `214 stars today`

1. [harry0703 / MoneyPrinterTurbo](https://github.com/harry0703/MoneyPrinterTurbo)
    - 利用AI大模型，一键生成高清短视频 Generate short videos with one click using AI LLM.
    - language: **Python** &nbsp;&nbsp; stars: **17,281** &nbsp;&nbsp; folks: **2,708**  &nbsp;&nbsp; `163 stars today`
...
1. [khoj-ai / khoj](https://github.com/khoj-ai/khoj)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **14,241** &nbsp;&nbsp; folks: **705**  &nbsp;&nbsp; `117 stars today`

1. [AlexxIT / go2rtc](https://github.com/AlexxIT/go2rtc)
    - Ultimate camera streaming application with support RTSP, RTMP, HTTP-FLV, WebRTC, MSE, HLS, MP4, MJPEG, HomeKit, FFmpeg, etc.
    - language: **Go** &nbsp;&nbsp; stars: **5,911** &nbsp;&nbsp; folks: **442**  &nbsp;&nbsp; `297 stars today`
...
1. [adityatelange / hugo-PaperMod](https://github.com/adityatelange/hugo-PaperMod)
    ...
    - language: **HTML** &nbsp;&nbsp; stars: **10,043** &nbsp;&nbsp; folks: **2,708**  &nbsp;&nbsp; `17 stars today`
...
1. [All-Hands-AI / OpenHands](https://github.com/All-Hands-AI/OpenHands)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **35,572** &nbsp;&nbsp; folks: **4,038**  &nbsp;&nbsp; `1,917 stars this week`
...
1. [khoj-ai / khoj](https://github.com/khoj-ai/khoj)
    - Your AI second brain. Self-hostable. Get answers from the web or your docs. Build custom agents, schedule automations, do deep research. Turn any online or local LLM into your personal, autonomous AI (e.g gpt, claude, gemini, llama, qwen, mistral).
    - language: **Python** &nbsp;&nbsp; stars: **14,241** &nbsp;&nbsp; folks: **705**  &nbsp;&nbsp; `1,010 stars this week`
...
1. [dockur / windows](https://github.com/dockur/windows)
    - Windows inside a Docker container.
    - language: **Shell** &nbsp;&nbsp; stars: **22,000** &nbsp;&nbsp; folks: **1,708**  &nbsp;&nbsp; `2,261 stars this week`
