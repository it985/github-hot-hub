...
1. [mediar-ai / screenpipe](https://github.com/mediar-ai/screenpipe)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **5,155** &nbsp;&nbsp; folks: **278**  &nbsp;&nbsp; `1,100 stars today`

1. [unclecode / crawl4ai](https://github.com/unclecode/crawl4ai)
    - 🔥🕷️ Crawl4AI: Open-source LLM Friendly Web Crawler & Scrapper
    - language: **Python** &nbsp;&nbsp; stars: **9,864** &nbsp;&nbsp; folks: **703**  &nbsp;&nbsp; `1,857 stars today`

1. [mainmatter / 100-exercises-to-learn-rust](https://github.com/mainmatter/100-exercises-to-learn-rust)
    - A self-paced course to learn Rust, one exercise at a time.
    - language: **Rust** &nbsp;&nbsp; stars: **4,378** &nbsp;&nbsp; folks: **824**  &nbsp;&nbsp; `87 stars today`
...
1. [OpenBB-finance / OpenBB](https://github.com/OpenBB-finance/OpenBB)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **31,043** &nbsp;&nbsp; folks: **2,864**  &nbsp;&nbsp; `217 stars today`

1. [godotengine / godot](https://github.com/godotengine/godot)
    - Godot Engine – Multi-platform 2D and 3D game engine
    - language: **C++** &nbsp;&nbsp; stars: **89,624** &nbsp;&nbsp; folks: **20,771**  &nbsp;&nbsp; `80 stars today`

1. [exo-explore / exo](https://github.com/exo-explore/exo)
    - Run your own AI cluster at home with everyday devices 📱💻 🖥️⌚
    - language: **Python** &nbsp;&nbsp; stars: **9,144** &nbsp;&nbsp; folks: **483**  &nbsp;&nbsp; `1,139 stars today`
...
1. [Cinnamon / kotaemon](https://github.com/Cinnamon/kotaemon)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **13,259** &nbsp;&nbsp; folks: **991**  &nbsp;&nbsp; `250 stars today`

1. [Anuken / Mindustry](https://github.com/Anuken/Mindustry)
    - The automation tower defense RTS
    - language: **Java** &nbsp;&nbsp; stars: **22,415** &nbsp;&nbsp; folks: **2,940**  &nbsp;&nbsp; `24 stars today`
...
1. [keploy / keploy](https://github.com/keploy/keploy)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **4,678** &nbsp;&nbsp; folks: **442**  &nbsp;&nbsp; `145 stars today`

1. [ultralytics / ultralytics](https://github.com/ultralytics/ultralytics)
    - Ultralytics YOLO11 🚀
    - language: **Python** &nbsp;&nbsp; stars: **29,312** &nbsp;&nbsp; folks: **5,766**  &nbsp;&nbsp; `72 stars today`
...
1. [unclecode / crawl4ai](https://github.com/unclecode/crawl4ai)
    - 🔥🕷️ Crawl4AI: Open-source LLM Friendly Web Crawler & Scrapper
    - language: **Python** &nbsp;&nbsp; stars: **9,864** &nbsp;&nbsp; folks: **703**  &nbsp;&nbsp; `5,924 stars this week`
...
1. [exo-explore / exo](https://github.com/exo-explore/exo)
    - Run your own AI cluster at home with everyday devices 📱💻 🖥️⌚
    - language: **Python** &nbsp;&nbsp; stars: **9,144** &nbsp;&nbsp; folks: **483**  &nbsp;&nbsp; `1,998 stars this week`

1. [mediar-ai / screenpipe](https://github.com/mediar-ai/screenpipe)
    - 24/7 local AI screen & mic recording. Build AI apps that have the full context. Works with Ollama. Alternative to Rewind.ai. Open. Secure. You own your data. Rust.
    - language: **Rust** &nbsp;&nbsp; stars: **5,155** &nbsp;&nbsp; folks: **278**  &nbsp;&nbsp; `2,594 stars this week`
...
1. [immich-app / immich](https://github.com/immich-app/immich)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **47,017** &nbsp;&nbsp; folks: **2,338**  &nbsp;&nbsp; `1,579 stars this week`
...
1. [OpenBB-finance / OpenBB](https://github.com/OpenBB-finance/OpenBB)
    - Investment Research for Everyone, Everywhere.
    - language: **Python** &nbsp;&nbsp; stars: **31,043** &nbsp;&nbsp; folks: **2,864**  &nbsp;&nbsp; `525 stars this week`
...
1. [Zeyi-Lin / HivisionIDPhotos](https://github.com/Zeyi-Lin/HivisionIDPhotos)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **10,466** &nbsp;&nbsp; folks: **1,020**  &nbsp;&nbsp; `9,304 stars this month`
...
1. [mediar-ai / screenpipe](https://github.com/mediar-ai/screenpipe)
    - 24/7 local AI screen & mic recording. Build AI apps that have the full context. Works with Ollama. Alternative to Rewind.ai. Open. Secure. You own your data. Rust.
    - language: **Rust** &nbsp;&nbsp; stars: **5,155** &nbsp;&nbsp; folks: **278**  &nbsp;&nbsp; `3,001 stars this month`
...
1. [Cinnamon / kotaemon](https://github.com/Cinnamon/kotaemon)
    - An open-source RAG-based tool for chatting with your documents.
    - language: **Python** &nbsp;&nbsp; stars: **13,259** &nbsp;&nbsp; folks: **991**  &nbsp;&nbsp; `6,715 stars this month`
