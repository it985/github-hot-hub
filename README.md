...
1. [TabbyML / tabby](https://github.com/TabbyML/tabby)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **25,837** &nbsp;&nbsp; folks: **1,177**  &nbsp;&nbsp; `1,032 stars today`

1. [RealKai42 / qwerty-learner](https://github.com/RealKai42/qwerty-learner)
    - 为键盘工作者设计的单词记忆与英语肌肉记忆锻炼软件 / Words learning and English muscle memory training software designed for keyboard workers
    - language: **TypeScript** &nbsp;&nbsp; stars: **16,764** &nbsp;&nbsp; folks: **1,616**  &nbsp;&nbsp; `118 stars today`
...
1. [DrewThomasson / ebook2audiobook](https://github.com/DrewThomasson/ebook2audiobook)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **7,040** &nbsp;&nbsp; folks: **484**  &nbsp;&nbsp; `243 stars today`

1. [dnhkng / GlaDOS](https://github.com/dnhkng/GlaDOS)
    - This is the Personality Core for GLaDOS, the first steps towards a real-life implementation of the AI from the Portal series by Valve.
    - language: **Python** &nbsp;&nbsp; stars: **3,963** &nbsp;&nbsp; folks: **321**  &nbsp;&nbsp; `145 stars today`

1. [automatisch / automatisch](https://github.com/automatisch/automatisch)
    - The open source Zapier alternative. Build workflow automation without spending time and money.
    - language: **JavaScript** &nbsp;&nbsp; stars: **7,399** &nbsp;&nbsp; folks: **533**  &nbsp;&nbsp; `318 stars today`
...
1. [AppFlowy-IO / AppFlowy](https://github.com/AppFlowy-IO/AppFlowy)
    ...
    - language: **Dart** &nbsp;&nbsp; stars: **59,739** &nbsp;&nbsp; folks: **3,965**  &nbsp;&nbsp; `174 stars today`
...
1. [khoj-ai / khoj](https://github.com/khoj-ai/khoj)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **24,528** &nbsp;&nbsp; folks: **1,312**  &nbsp;&nbsp; `4,324 stars this week`
...
1. [srbhr / Resume-Matcher](https://github.com/srbhr/Resume-Matcher)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **7,671** &nbsp;&nbsp; folks: **2,686**  &nbsp;&nbsp; `1,464 stars this week`
...
1. [Canner / WrenAI](https://github.com/Canner/WrenAI)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,263** &nbsp;&nbsp; folks: **355**  &nbsp;&nbsp; `1,304 stars this week`
...
1. [mudler / LocalAI](https://github.com/mudler/LocalAI)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **28,430** &nbsp;&nbsp; folks: **2,135**  &nbsp;&nbsp; `672 stars this week`

1. [cline / cline](https://github.com/cline/cline)
    - Autonomous coding agent right in your IDE, capable of creating/editing files, executing commands, using the browser, and more with your permission every step of the way.
    - language: **TypeScript** &nbsp;&nbsp; stars: **22,330** &nbsp;&nbsp; folks: **1,936**  &nbsp;&nbsp; `2,301 stars this week`
...
1. [Shubhamsaboo / awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **12,460** &nbsp;&nbsp; folks: **1,336**  &nbsp;&nbsp; `6,778 stars this month`

1. [khoj-ai / khoj](https://github.com/khoj-ai/khoj)
    - Your AI second brain. Self-hostable. Get answers from the web or your docs. Build custom agents, schedule automations, do deep research. Turn any online or local LLM into your personal, autonomous AI (gpt, claude, gemini, llama, qwen, mistral). Get started - free.
    - language: **Python** &nbsp;&nbsp; stars: **24,528** &nbsp;&nbsp; folks: **1,312**  &nbsp;&nbsp; `7,431 stars this month`
