...
1. [TheLastBen / fast-stable-diffusion](https://github.com/TheLastBen/fast-stable-diffusion)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **4,430** &nbsp;&nbsp; folks: **703**  &nbsp;&nbsp; `32 stars today`

1. [sindresorhus / awesome](https://github.com/sindresorhus/awesome)
    - 😎 Awesome lists about all kinds of interesting topics
    - language: **无** &nbsp;&nbsp; stars: **242,712** &nbsp;&nbsp; folks: **25,115**  &nbsp;&nbsp; `240 stars today`
...
1. [Postcatlab / postcat](https://github.com/Postcatlab/postcat)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **1,691** &nbsp;&nbsp; folks: **245**  &nbsp;&nbsp; `156 stars today`

1. [oobabooga / text-generation-webui](https://github.com/oobabooga/text-generation-webui)
    - A gradio web UI for running Large Language Models like GPT-J 6B, OPT, GALACTICA, LLaMA, and Pygmalion.
    - language: **Python** &nbsp;&nbsp; stars: **1,785** &nbsp;&nbsp; folks: **140**  &nbsp;&nbsp; `408 stars today`
...
1. [shawwn / llama-dl](https://github.com/shawwn/llama-dl)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **2,296** &nbsp;&nbsp; folks: **241**  &nbsp;&nbsp; `432 stars today`

1. [yetone / openai-translator](https://github.com/yetone/openai-translator)
    - 基于 ChatGPT API 的划词翻译浏览器插件和跨平台桌面端应用 - Browser extension and cross-platform desktop application for translation based on ChatGPT API.
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,282** &nbsp;&nbsp; folks: **297**  &nbsp;&nbsp; `1,039 stars today`

1. [nodejs / nodejs.org](https://github.com/nodejs/nodejs.org)
    - The Node.js website.
    - language: **JavaScript** &nbsp;&nbsp; stars: **2,513** &nbsp;&nbsp; folks: **5,860**  &nbsp;&nbsp; `46 stars today`

1. [mli / paper-reading](https://github.com/mli/paper-reading)
    - 深度学习经典、新论文逐段精读
    - language: **无** &nbsp;&nbsp; stars: **14,926** &nbsp;&nbsp; folks: **1,462**  &nbsp;&nbsp; `226 stars today`
...
1. [iptv-org / iptv](https://github.com/iptv-org/iptv)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **62,600** &nbsp;&nbsp; folks: **25**  &nbsp;&nbsp; `34 stars today`
...
1. [ddiu8081 / chatgpt-demo](https://github.com/ddiu8081/chatgpt-demo)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,939** &nbsp;&nbsp; folks: **1,550**  &nbsp;&nbsp; `2,947 stars this week`

1. [ServiceWeaver / weaver](https://github.com/ServiceWeaver/weaver)
    - Programming framework for writing and deploying cloud applications.
    - language: **Go** &nbsp;&nbsp; stars: **2,623** &nbsp;&nbsp; folks: **88**  &nbsp;&nbsp; `1,932 stars this week`

1. [Chanzhaoyu / chatgpt-web](https://github.com/Chanzhaoyu/chatgpt-web)
    - 用 Express 和 Vue3 搭建的 ChatGPT 演示网页
    - language: **Vue** &nbsp;&nbsp; stars: **5,673** &nbsp;&nbsp; folks: **1,374**  &nbsp;&nbsp; `3,021 stars this week`
...
1. [oobabooga / text-generation-webui](https://github.com/oobabooga/text-generation-webui)
    - A gradio web UI for running Large Language Models like GPT-J 6B, OPT, GALACTICA, LLaMA, and Pygmalion.
    - language: **Python** &nbsp;&nbsp; stars: **1,785** &nbsp;&nbsp; folks: **140**  &nbsp;&nbsp; `1,147 stars this week`

1. [Asabeneh / 30-Days-Of-Python](https://github.com/Asabeneh/30-Days-Of-Python)
    - 30 days of Python programming challenge is a step-by-step guide to learn the Python programming language in 30 days. This challenge may take more than100 days, follow your own pace.
    - language: **Python** &nbsp;&nbsp; stars: **22,041** &nbsp;&nbsp; folks: **4,679**  &nbsp;&nbsp; `2,196 stars this week`
...
1. [openai / openai-cookbook](https://github.com/openai/openai-cookbook)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **17,114** &nbsp;&nbsp; folks: **2,307**  &nbsp;&nbsp; `1,978 stars this week`
...
1. [hwchase17 / langchain](https://github.com/hwchase17/langchain)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **10,302** &nbsp;&nbsp; folks: **917**  &nbsp;&nbsp; `1,315 stars this week`
...
1. [excalidraw / excalidraw](https://github.com/excalidraw/excalidraw)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **43,636** &nbsp;&nbsp; folks: **3,649**  &nbsp;&nbsp; `1,175 stars this week`

1. [godotengine / godot](https://github.com/godotengine/godot)
    - Godot Engine – Multi-platform 2D and 3D game engine
    - language: **C++** &nbsp;&nbsp; stars: **59,148** &nbsp;&nbsp; folks: **10,221**  &nbsp;&nbsp; `472 stars this week`
...
1. [PlexPt / awesome-chatgpt-prompts-zh](https://github.com/PlexPt/awesome-chatgpt-prompts-zh)
    ...
    - language: **无** &nbsp;&nbsp; stars: **13,612** &nbsp;&nbsp; folks: **4,638**  &nbsp;&nbsp; `8,440 stars this month`

1. [waylaidwanderer / node-chatgpt-api](https://github.com/waylaidwanderer/node-chatgpt-api)
    - A client implementation for ChatGPT and Bing AI. Available as a Node.js module, REST API server, and CLI app.
    - language: **JavaScript** &nbsp;&nbsp; stars: **2,064** &nbsp;&nbsp; folks: **298**  &nbsp;&nbsp; `1,279 stars this month`
...
1. [lencx / ChatGPT](https://github.com/lencx/ChatGPT)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **20,954** &nbsp;&nbsp; folks: **2,070**  &nbsp;&nbsp; `8,402 stars this month`
...
1. [ytdl-org / youtube-dl](https://github.com/ytdl-org/youtube-dl)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **118,595** &nbsp;&nbsp; folks: **8,742**  &nbsp;&nbsp; `1,606 stars this month`
