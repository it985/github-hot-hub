...
1. [Lightning-AI / LitServe](https://github.com/Lightning-AI/LitServe)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **1,478** &nbsp;&nbsp; folks: **95**  &nbsp;&nbsp; `394 stars today`

1. [Permify / permify](https://github.com/Permify/permify)
    - An open-source authorization as a service inspired by Google Zanzibar, designed to build and manage fine-grained and scalable authorization systems for any application.
    - language: **Go** &nbsp;&nbsp; stars: **3,903** &nbsp;&nbsp; folks: **178**  &nbsp;&nbsp; `111 stars today`

1. [sherlock-project / sherlock](https://github.com/sherlock-project/sherlock)
    - Hunt down social media accounts by username across social networks
    - language: **Python** &nbsp;&nbsp; stars: **55,292** &nbsp;&nbsp; folks: **6,565**  &nbsp;&nbsp; `783 stars today`

1. [Z4nzu / hackingtool](https://github.com/Z4nzu/hackingtool)
    - ALL IN ONE Hacking Tool For Hackers
    - language: **Python** &nbsp;&nbsp; stars: **45,801** &nbsp;&nbsp; folks: **4,981**  &nbsp;&nbsp; `838 stars today`
...
1. [langgenius / dify](https://github.com/langgenius/dify)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **43,263** &nbsp;&nbsp; folks: **5,992**  &nbsp;&nbsp; `129 stars today`
...
1. [hacksider / Deep-Live-Cam](https://github.com/hacksider/Deep-Live-Cam)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **31,020** &nbsp;&nbsp; folks: **4,302**  &nbsp;&nbsp; `674 stars today`
...
1. [astral-sh / uv](https://github.com/astral-sh/uv)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **18,251** &nbsp;&nbsp; folks: **531**  &nbsp;&nbsp; `2,117 stars this week`
...
1. [sherlock-project / sherlock](https://github.com/sherlock-project/sherlock)
    - Hunt down social media accounts by username across social networks
    - language: **Python** &nbsp;&nbsp; stars: **55,292** &nbsp;&nbsp; folks: **6,565**  &nbsp;&nbsp; `1,307 stars this week`
...
1. [deepset-ai / haystack](https://github.com/deepset-ai/haystack)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **15,943** &nbsp;&nbsp; folks: **1,792**  &nbsp;&nbsp; `713 stars this week`
...
1. [opendatalab / MinerU](https://github.com/opendatalab/MinerU)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **10,157** &nbsp;&nbsp; folks: **744**  &nbsp;&nbsp; `8,232 stars this month`
...
1. [drawdb-io / drawdb](https://github.com/drawdb-io/drawdb)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **19,514** &nbsp;&nbsp; folks: **1,345**  &nbsp;&nbsp; `6,133 stars this month`
...
1. [kamranahmedse / developer-roadmap](https://github.com/kamranahmedse/developer-roadmap)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **289,181** &nbsp;&nbsp; folks: **38,316**  &nbsp;&nbsp; `5,482 stars this month`

1. [GyulyVGC / sniffnet](https://github.com/GyulyVGC/sniffnet)
    - Comfortably monitor your Internet traffic 🕵️‍♂️
    - language: **Rust** &nbsp;&nbsp; stars: **17,487** &nbsp;&nbsp; folks: **528**  &nbsp;&nbsp; `2,576 stars this month`

1. [infiniflow / ragflow](https://github.com/infiniflow/ragflow)
    - RAGFlow is an open-source RAG (Retrieval-Augmented Generation) engine based on deep document understanding.
    - language: **Python** &nbsp;&nbsp; stars: **15,630** &nbsp;&nbsp; folks: **1,581**  &nbsp;&nbsp; `2,937 stars this month`
