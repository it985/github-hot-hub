...
`更新时间：2025-04-22 09:37:59 +0800`

## 今日热门仓库

1. [microsoft / markitdown](https://github.com/microsoft/markitdown)
    - Python tool for converting files and office documents to Markdown.
    - language: **Python** &nbsp;&nbsp; stars: **51,432** &nbsp;&nbsp; folks: **2,512**  &nbsp;&nbsp; `1,033 stars today`

1. [microsoft / BitNet](https://github.com/microsoft/BitNet)
    - Official inference framework for 1-bit LLMs
    - language: **C++** &nbsp;&nbsp; stars: **15,610** &nbsp;&nbsp; folks: **1,109**  &nbsp;&nbsp; `697 stars today`
...
1. [elie222 / inbox-zero](https://github.com/elie222/inbox-zero)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **6,636** &nbsp;&nbsp; folks: **684**  &nbsp;&nbsp; `258 stars today`

1. [Shubhamsaboo / awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps)
    - Collection of awesome LLM apps with AI Agents and RAG using OpenAI, Anthropic, Gemini and opensource models.
    - language: **Python** &nbsp;&nbsp; stars: **29,230** &nbsp;&nbsp; folks: **3,271**  &nbsp;&nbsp; `322 stars today`

1. [allenai / olmocr](https://github.com/allenai/olmocr)
    - Toolkit for linearizing PDFs for LLM datasets/training
    - language: **Python** &nbsp;&nbsp; stars: **11,674** &nbsp;&nbsp; folks: **789**  &nbsp;&nbsp; `148 stars today`

1. [yt-dlp / yt-dlp](https://github.com/yt-dlp/yt-dlp)
    - A feature-rich command-line audio/video downloader
    - language: **Python** &nbsp;&nbsp; stars: **108,680** &nbsp;&nbsp; folks: **8,535**  &nbsp;&nbsp; `329 stars today`

1. [drawdb-io / drawdb](https://github.com/drawdb-io/drawdb)
    - Free, simple, and intuitive online database diagram editor and SQL generator.
    - language: **JavaScript** &nbsp;&nbsp; stars: **27,319** &nbsp;&nbsp; folks: **1,938**  &nbsp;&nbsp; `104 stars today`
...
1. [nocobase / nocobase](https://github.com/nocobase/nocobase)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **15,039** &nbsp;&nbsp; folks: **1,650**  &nbsp;&nbsp; `243 stars today`

1. [public-apis / public-apis](https://github.com/public-apis/public-apis)
    - A collective list of free APIs
    - language: **Python** &nbsp;&nbsp; stars: **337,258** &nbsp;&nbsp; folks: **35,629**  &nbsp;&nbsp; `610 stars today`

1. [jwasham / coding-interview-university](https://github.com/jwasham/coding-interview-university)
    - A complete computer science study plan to become a software engineer.
    - language: **无** &nbsp;&nbsp; stars: **315,209** &nbsp;&nbsp; folks: **78,505**  &nbsp;&nbsp; `288 stars today`

1. [Byaidu / PDFMathTranslate](https://github.com/Byaidu/PDFMathTranslate)
    - PDF scientific paper translation with preserved formats - 基于 AI 完整保留排版的 PDF 文档全文双语翻译，支持 Google/DeepL/Ollama/OpenAI 等服务，提供 CLI/GUI/Docker/Zotero
    - language: **Python** &nbsp;&nbsp; stars: **21,160** &nbsp;&nbsp; folks: **1,794**  &nbsp;&nbsp; `471 stars today`
...
1. [007revad / Synology_HDD_db](https://github.com/007revad/Synology_HDD_db)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **3,560** &nbsp;&nbsp; folks: **226**  &nbsp;&nbsp; `56 stars today`

1. [jumpserver / jumpserver](https://github.com/jumpserver/jumpserver)
    - JumpServer is an open-source Privileged Access Management (PAM) tool that provides DevOps and IT teams with on-demand and secure access to SSH, RDP, Kubernetes, Database and RemoteApp endpoints through a web browser.
    - language: **Python** &nbsp;&nbsp; stars: **27,029** &nbsp;&nbsp; folks: **5,450**  &nbsp;&nbsp; `166 stars today`
...
1. [virattt / ai-hedge-fund](https://github.com/virattt/ai-hedge-fund)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **26,150** &nbsp;&nbsp; folks: **4,482**  &nbsp;&nbsp; `4,759 stars this week`
...
1. [yeongpin / cursor-free-vip](https://github.com/yeongpin/cursor-free-vip)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **20,382** &nbsp;&nbsp; folks: **2,503**  &nbsp;&nbsp; `5,816 stars this week`
...
1. [Zackriya-Solutions / meeting-minutes](https://github.com/Zackriya-Solutions/meeting-minutes)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **4,322** &nbsp;&nbsp; folks: **291**  &nbsp;&nbsp; `1,865 stars this week`

1. [jlowin / fastmcp](https://github.com/jlowin/fastmcp)
    - 🚀 The fast, Pythonic way to build MCP servers and clients
    - language: **Python** &nbsp;&nbsp; stars: **6,788** &nbsp;&nbsp; folks: **354**  &nbsp;&nbsp; `2,026 stars this week`

1. [krillinai / KrillinAI](https://github.com/krillinai/KrillinAI)
    - A video translation and dubbing tool powered by LLMs, offering professional-grade translations and one-click full-process deployment. It can generate content optimized for platforms like YouTube，TikTok, and Shorts. 基于AI大模型的视频翻译和配音工具，专业级翻译，一键部署全流程，可以生成适配抖音，小红书，哔哩哔哩，视频号，TikTok，Youtube Shorts等形态的内容
    - language: **Go** &nbsp;&nbsp; stars: **5,776** &nbsp;&nbsp; folks: **413**  &nbsp;&nbsp; `1,941 stars this week`

1. [nocobase / nocobase](https://github.com/nocobase/nocobase)
    - NocoBase is an extensibility-first, open-source no-code/low-code platform for building business applications and enterprise solutions.
    - language: **TypeScript** &nbsp;&nbsp; stars: **15,039** &nbsp;&nbsp; folks: **1,650**  &nbsp;&nbsp; `866 stars this week`

1. [docmost / docmost](https://github.com/docmost/docmost)
    - Docmost is an open-source collaborative wiki and documentation software. It is an open-source alternative to Confluence and Notion.
    - language: **TypeScript** &nbsp;&nbsp; stars: **14,563** &nbsp;&nbsp; folks: **701**  &nbsp;&nbsp; `1,221 stars this week`

1. [elie222 / inbox-zero](https://github.com/elie222/inbox-zero)
    - AI personal assistant for email. Open source app to help you reach inbox zero fast.
    - language: **TypeScript** &nbsp;&nbsp; stars: **6,636** &nbsp;&nbsp; folks: **684**  &nbsp;&nbsp; `973 stars this week`
...
1. [spring-projects / spring-ai](https://github.com/spring-projects/spring-ai)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **4,775** &nbsp;&nbsp; folks: **1,304**  &nbsp;&nbsp; `135 stars this week`
...
1. [svcvit / Awesome-Dify-Workflow](https://github.com/svcvit/Awesome-Dify-Workflow)
    ...
    - language: **无** &nbsp;&nbsp; stars: **6,409** &nbsp;&nbsp; folks: **618**  &nbsp;&nbsp; `975 stars this week`

1. [paperless-ngx / paperless-ngx](https://github.com/paperless-ngx/paperless-ngx)
    - A community-supported supercharged version of paperless: scan, index and archive all your physical documents
    - language: **Python** &nbsp;&nbsp; stars: **26,534** &nbsp;&nbsp; folks: **1,550**  &nbsp;&nbsp; `178 stars this week`
...
1. [yeongpin / cursor-free-vip](https://github.com/yeongpin/cursor-free-vip)
    - [Support 0.48.x]（Reset Cursor AI MachineID & Bypass Higher Token Limit） Cursor Ai ，自动重置机器ID ， 免费升级使用Pro功能: You've reached your trial request limit. / Too many free trial accounts used on this machine. Please upgrade to pro. We have this limit in place to prevent abuse. Please let us know if you believe this is a mistake.
    - language: **Python** &nbsp;&nbsp; stars: **20,382** &nbsp;&nbsp; folks: **2,503**  &nbsp;&nbsp; `16,598 stars this month`

1. [punkpeye / awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers)
    - A collection of MCP servers.
    - language: **无** &nbsp;&nbsp; stars: **41,141** &nbsp;&nbsp; folks: **2,965**  &nbsp;&nbsp; `27,670 stars this month`

1. [bytedance / UI-TARS-desktop](https://github.com/bytedance/UI-TARS-desktop)
    - A GUI Agent application based on UI-TARS(Vision-Language Model) that allows you to control your computer using natural language.
    - language: **TypeScript** &nbsp;&nbsp; stars: **12,141** &nbsp;&nbsp; folks: **959**  &nbsp;&nbsp; `8,351 stars this month`
...
1. [microsoft / ai-agents-for-beginners](https://github.com/microsoft/ai-agents-for-beginners)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **16,314** &nbsp;&nbsp; folks: **4,026**  &nbsp;&nbsp; `11,378 stars this month`

1. [n8n-io / n8n](https://github.com/n8n-io/n8n)
    - Fair-code workflow automation platform with native AI capabilities. Combine visual building with custom code, self-host or cloud, 400+ integrations.
    - language: **TypeScript** &nbsp;&nbsp; stars: **84,221** &nbsp;&nbsp; folks: **22,675**  &nbsp;&nbsp; `15,039 stars this month`

1. [alibaba / spring-ai-alibaba](https://github.com/alibaba/spring-ai-alibaba)
    - Agentic AI Framework for Java Developers
    - language: **Java** &nbsp;&nbsp; stars: **2,398** &nbsp;&nbsp; folks: **460**  &nbsp;&nbsp; `1,225 stars this month`
...
1. [Shubhamsaboo / awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps)
    - Collection of awesome LLM apps with AI Agents and RAG using OpenAI, Anthropic, Gemini and opensource models.
    - language: **Python** &nbsp;&nbsp; stars: **29,230** &nbsp;&nbsp; folks: **3,271**  &nbsp;&nbsp; `9,102 stars this month`
...
1. [mark3labs / mcp-go](https://github.com/mark3labs/mcp-go)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **3,673** &nbsp;&nbsp; folks: **301**  &nbsp;&nbsp; `2,699 stars this month`

1. [wonderwhy-er / DesktopCommanderMCP](https://github.com/wonderwhy-er/DesktopCommanderMCP)
    - This is MCP server for Claude that gives it terminal control, file system search and diff file editing capabilities
    - language: **TypeScript** &nbsp;&nbsp; stars: **1,855** &nbsp;&nbsp; folks: **192**  &nbsp;&nbsp; `1,618 stars this month`
...
1. [ageerle / ruoyi-ai](https://github.com/ageerle/ruoyi-ai)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **2,836** &nbsp;&nbsp; folks: **638**  &nbsp;&nbsp; `2,129 stars this month`

1. [PatrickJS / awesome-cursorrules](https://github.com/PatrickJS/awesome-cursorrules)
    - 📄 A curated list of awesome .cursorrules files
    - language: **无** &nbsp;&nbsp; stars: **22,775** &nbsp;&nbsp; folks: **1,732**  &nbsp;&nbsp; `5,745 stars this month`
