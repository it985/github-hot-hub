...
`更新时间：2024-12-24 10:49:02 +0800`

## 今日热门仓库

1. [nicbarker / clay](https://github.com/nicbarker/clay)
    - High performance UI layout library in C.
    - language: **C** &nbsp;&nbsp; stars: **6,865** &nbsp;&nbsp; folks: **189**  &nbsp;&nbsp; `1,493 stars today`

1. [donnemartin / system-design-primer](https://github.com/donnemartin/system-design-primer)
    - Learn how to design large-scale systems. Prep for the system design interview. Includes Anki flashcards.
    - language: **Python** &nbsp;&nbsp; stars: **281,899** &nbsp;&nbsp; folks: **47,163**  &nbsp;&nbsp; `1,091 stars today`
...
1. [Shubhamsaboo / awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **8,246** &nbsp;&nbsp; folks: **841**  &nbsp;&nbsp; `342 stars today`

1. [anthropics / anthropic-cookbook](https://github.com/anthropics/anthropic-cookbook)
    - A collection of notebooks/recipes showcasing some fun and effective ways of using Claude.
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **8,060** &nbsp;&nbsp; folks: **1,017**  &nbsp;&nbsp; `228 stars today`
...
1. [malmeloo / FindMy.py](https://github.com/malmeloo/FindMy.py)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **1,333** &nbsp;&nbsp; folks: **38**  &nbsp;&nbsp; `231 stars today`

1. [Zipstack / unstract](https://github.com/Zipstack/unstract)
    - No-code LLM Platform to launch APIs and ETL Pipelines to structure unstructured documents
    - language: **Python** &nbsp;&nbsp; stars: **3,070** &nbsp;&nbsp; folks: **192**  &nbsp;&nbsp; `215 stars today`
...
1. [Shubhamsaboo / awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps)
    - Collection of awesome LLM apps with RAG using OpenAI, Anthropic, Gemini and opensource models.
    - language: **Python** &nbsp;&nbsp; stars: **8,246** &nbsp;&nbsp; folks: **841**  &nbsp;&nbsp; `1,533 stars this week`

1. [Byaidu / PDFMathTranslate](https://github.com/Byaidu/PDFMathTranslate)
    - PDF scientific paper translation with preserved formats - 基于 AI 完整保留排版的 PDF 文档全文双语翻译，支持 Google/DeepL/Ollama/OpenAI 等服务，提供 CLI/GUI/Docker
    - language: **Python** &nbsp;&nbsp; stars: **10,684** &nbsp;&nbsp; folks: **745**  &nbsp;&nbsp; `2,503 stars this week`
...
1. [1Panel-dev / 1Panel](https://github.com/1Panel-dev/1Panel)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **24,092** &nbsp;&nbsp; folks: **2,182**  &nbsp;&nbsp; `583 stars this week`

1. [anthropics / anthropic-cookbook](https://github.com/anthropics/anthropic-cookbook)
    - A collection of notebooks/recipes showcasing some fun and effective ways of using Claude.
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **8,060** &nbsp;&nbsp; folks: **1,017**  &nbsp;&nbsp; `650 stars this week`
...
1. [donnemartin / system-design-primer](https://github.com/donnemartin/system-design-primer)
    - Learn how to design large-scale systems. Prep for the system design interview. Includes Anki flashcards.
    - language: **Python** &nbsp;&nbsp; stars: **281,899** &nbsp;&nbsp; folks: **47,163**  &nbsp;&nbsp; `2,437 stars this week`
...
1. [Shubhamsaboo / awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps)
    - Collection of awesome LLM apps with RAG using OpenAI, Anthropic, Gemini and opensource models.
    - language: **Python** &nbsp;&nbsp; stars: **8,246** &nbsp;&nbsp; folks: **841**  &nbsp;&nbsp; `3,786 stars this month`
...
1. [Byaidu / PDFMathTranslate](https://github.com/Byaidu/PDFMathTranslate)
    - PDF scientific paper translation with preserved formats - 基于 AI 完整保留排版的 PDF 文档全文双语翻译，支持 Google/DeepL/Ollama/OpenAI 等服务，提供 CLI/GUI/Docker
    - language: **Python** &nbsp;&nbsp; stars: **10,684** &nbsp;&nbsp; folks: **745**  &nbsp;&nbsp; `7,867 stars this month`
...
1. [lobehub / lobe-chat](https://github.com/lobehub/lobe-chat)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **49,431** &nbsp;&nbsp; folks: **10,731**  &nbsp;&nbsp; `4,826 stars this month`
