...
`更新时间：2025-03-15 09:23:51 +0800`

## 今日热门仓库

1. [xpipe-io / xpipe](https://github.com/xpipe-io/xpipe)
    - Access your entire server infrastructure from your local desktop
    - language: **Java** &nbsp;&nbsp; stars: **7,316** &nbsp;&nbsp; folks: **241**  &nbsp;&nbsp; `795 stars today`

1. [freeCodeCamp / freeCodeCamp](https://github.com/freeCodeCamp/freeCodeCamp)
    - freeCodeCamp.org's open-source codebase and curriculum. Learn to code for free.
    - language: **TypeScript** &nbsp;&nbsp; stars: **412,368** &nbsp;&nbsp; folks: **39,293**  &nbsp;&nbsp; `297 stars today`

1. [glanceapp / glance](https://github.com/glanceapp/glance)
    - A self-hosted dashboard that puts all your feeds in one place
    - language: **Go** &nbsp;&nbsp; stars: **12,540** &nbsp;&nbsp; folks: **435**  &nbsp;&nbsp; `189 stars today`

1. [openai / openai-python](https://github.com/openai/openai-python)
    - The official Python library for the OpenAI API
    - language: **Python** &nbsp;&nbsp; stars: **25,359** &nbsp;&nbsp; folks: **3,678**  &nbsp;&nbsp; `47 stars today`

1. [hpcaitech / Open-Sora](https://github.com/hpcaitech/Open-Sora)
    - Open-Sora: Democratizing Efficient Video Production for All
    - language: **Python** &nbsp;&nbsp; stars: **24,473** &nbsp;&nbsp; folks: **2,400**  &nbsp;&nbsp; `356 stars today`

1. [YaLTeR / niri](https://github.com/YaLTeR/niri)
    - A scrollable-tiling Wayland compositor.
    - language: **Rust** &nbsp;&nbsp; stars: **6,158** &nbsp;&nbsp; folks: **202**  &nbsp;&nbsp; `298 stars today`

1. [microsoft / TypeScript](https://github.com/microsoft/TypeScript)
    - TypeScript is a superset of JavaScript that compiles to clean JavaScript output.
    - language: **TypeScript** &nbsp;&nbsp; stars: **103,326** &nbsp;&nbsp; folks: **12,736**  &nbsp;&nbsp; `247 stars today`
...
1. [yuaotian / go-cursor-help](https://github.com/yuaotian/go-cursor-help)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **13,852** &nbsp;&nbsp; folks: **1,814**  &nbsp;&nbsp; `255 stars today`

1. [kern / filepizza](https://github.com/kern/filepizza)
    - 🍕 Peer-to-peer file transfers in your browser
    - language: **TypeScript** &nbsp;&nbsp; stars: **6,305** &nbsp;&nbsp; folks: **400**  &nbsp;&nbsp; `454 stars today`
...
1. [clockworklabs / SpacetimeDB](https://github.com/clockworklabs/SpacetimeDB)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **10,085** &nbsp;&nbsp; folks: **331**  &nbsp;&nbsp; `4,132 stars this week`

1. [virattt / ai-hedge-fund](https://github.com/virattt/ai-hedge-fund)
    - An AI Hedge Fund Team
    - language: **Python** &nbsp;&nbsp; stars: **16,819** &nbsp;&nbsp; folks: **2,929**  &nbsp;&nbsp; `3,724 stars this week`

1. [browser-use / browser-use](https://github.com/browser-use/browser-use)
    - Make websites accessible for AI agents
    - language: **Python** &nbsp;&nbsp; stars: **43,949** &nbsp;&nbsp; folks: **4,460**  &nbsp;&nbsp; `7,480 stars this week`
...
1. [microsoft / TypeScript](https://github.com/microsoft/TypeScript)
    - TypeScript is a superset of JavaScript that compiles to clean JavaScript output.
    - language: **TypeScript** &nbsp;&nbsp; stars: **103,326** &nbsp;&nbsp; folks: **12,736**  &nbsp;&nbsp; `841 stars this week`

1. [CodePhiliaX / Chat2DB](https://github.com/CodePhiliaX/Chat2DB)
    - 🔥🔥🔥AI-driven database tool and SQL client, The hottest GUI client, supporting MySQL, Oracle, PostgreSQL, DB2, SQL Server, DB2, SQLite, H2, ClickHouse, and more.
    - language: **Java** &nbsp;&nbsp; stars: **20,556** &nbsp;&nbsp; folks: **2,268**  &nbsp;&nbsp; `985 stars this week`
...
1. [dagger / dagger](https://github.com/dagger/dagger)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **13,008** &nbsp;&nbsp; folks: **680**  &nbsp;&nbsp; `750 stars this week`

1. [freeCodeCamp / freeCodeCamp](https://github.com/freeCodeCamp/freeCodeCamp)
    - freeCodeCamp.org's open-source codebase and curriculum. Learn to code for free.
    - language: **TypeScript** &nbsp;&nbsp; stars: **412,368** &nbsp;&nbsp; folks: **39,293**  &nbsp;&nbsp; `1,471 stars this week`
...
1. [KRTirtho / spotube](https://github.com/KRTirtho/spotube)
    ...
    - language: **Dart** &nbsp;&nbsp; stars: **38,128** &nbsp;&nbsp; folks: **1,557**  &nbsp;&nbsp; `1,623 stars this week`
...
1. [refly-ai / refly](https://github.com/refly-ai/refly)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,479** &nbsp;&nbsp; folks: **196**  &nbsp;&nbsp; `488 stars this week`
...
1. [microsoft / OmniParser](https://github.com/microsoft/OmniParser)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **20,368** &nbsp;&nbsp; folks: **1,659**  &nbsp;&nbsp; `14,768 stars this month`
...
1. [LadybirdBrowser / ladybird](https://github.com/LadybirdBrowser/ladybird)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **35,706** &nbsp;&nbsp; folks: **1,492**  &nbsp;&nbsp; `7,827 stars this month`

1. [langgenius / dify](https://github.com/langgenius/dify)
    - Dify is an open-source LLM app development platform. Dify's intuitive interface combines AI workflow, RAG pipeline, agent capabilities, model management, observability features and more, letting you quickly go from prototype to production.
    - language: **TypeScript** &nbsp;&nbsp; stars: **82,168** &nbsp;&nbsp; folks: **12,071**  &nbsp;&nbsp; `15,381 stars this month`
...
1. [codecrafters-io / build-your-own-x](https://github.com/codecrafters-io/build-your-own-x)
    ...
    - language: **Markdown** &nbsp;&nbsp; stars: **357,127** &nbsp;&nbsp; folks: **33,112**  &nbsp;&nbsp; `24,252 stars this month`
...
1. [virattt / ai-hedge-fund](https://github.com/virattt/ai-hedge-fund)
    - An AI Hedge Fund Team
    - language: **Python** &nbsp;&nbsp; stars: **16,819** &nbsp;&nbsp; folks: **2,929**  &nbsp;&nbsp; `8,449 stars this month`

1. [n8n-io / n8n](https://github.com/n8n-io/n8n)
    - Fair-code workflow automation platform with native AI capabilities. Combine visual building with custom code, self-host or cloud, 400+ integrations.
    - language: **TypeScript** &nbsp;&nbsp; stars: **67,339** &nbsp;&nbsp; folks: **16,888**  &nbsp;&nbsp; `6,916 stars this month`
...
1. [mendableai / firecrawl](https://github.com/mendableai/firecrawl)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **31,100** &nbsp;&nbsp; folks: **2,641**  &nbsp;&nbsp; `5,427 stars this month`
...
1. [hiyouga / LLaMA-Factory](https://github.com/hiyouga/LLaMA-Factory)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **44,165** &nbsp;&nbsp; folks: **5,403**  &nbsp;&nbsp; `3,822 stars this month`
