...
`更新时间：2025-01-14 20:34:20 +0800`

## 今日热门仓库

1. [TabbyML / tabby](https://github.com/TabbyML/tabby)
    - Self-hosted AI coding assistant
    - language: **Rust** &nbsp;&nbsp; stars: **24,734** &nbsp;&nbsp; folks: **1,128**  &nbsp;&nbsp; `1,210 stars today`

1. [RealKai42 / qwerty-learner](https://github.com/RealKai42/qwerty-learner)
    - 为键盘工作者设计的单词记忆与英语肌肉记忆锻炼软件 / Words learning and English muscle memory training software designed for keyboard workers
    - language: **TypeScript** &nbsp;&nbsp; stars: **16,456** &nbsp;&nbsp; folks: **1,595**  &nbsp;&nbsp; `291 stars today`
...
1. [automatisch / automatisch](https://github.com/automatisch/automatisch)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **7,187** &nbsp;&nbsp; folks: **520**  &nbsp;&nbsp; `61 stars today`
...
1. [FujiwaraChoki / MoneyPrinterV2](https://github.com/FujiwaraChoki/MoneyPrinterV2)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **4,755** &nbsp;&nbsp; folks: **520**  &nbsp;&nbsp; `173 stars today`

1. [yt-dlp / yt-dlp](https://github.com/yt-dlp/yt-dlp)
    - A feature-rich command-line audio/video downloader
    - language: **Python** &nbsp;&nbsp; stars: **96,456** &nbsp;&nbsp; folks: **7,557**  &nbsp;&nbsp; `152 stars today`

1. [nautechsystems / nautilus_trader](https://github.com/nautechsystems/nautilus_trader)
    - A high-performance algorithmic trading platform and event-driven backtester
    - language: **Python** &nbsp;&nbsp; stars: **2,599** &nbsp;&nbsp; folks: **551**  &nbsp;&nbsp; `50 stars today`

1. [BuilderIO / gpt-crawler](https://github.com/BuilderIO/gpt-crawler)
    - Crawl a site to generate knowledge files to create your own custom GPT from a URL
    - language: **TypeScript** &nbsp;&nbsp; stars: **20,020** &nbsp;&nbsp; folks: **2,124**  &nbsp;&nbsp; `250 stars today`
...
1. [78 / xiaozhi-esp32](https://github.com/78/xiaozhi-esp32)
    ...
    - language: **C** &nbsp;&nbsp; stars: **2,900** &nbsp;&nbsp; folks: **449**  &nbsp;&nbsp; `1,646 stars this week`
...
1. [Canner / WrenAI](https://github.com/Canner/WrenAI)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,152** &nbsp;&nbsp; folks: **350**  &nbsp;&nbsp; `1,214 stars this week`
...
1. [unclecode / crawl4ai](https://github.com/unclecode/crawl4ai)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **24,656** &nbsp;&nbsp; folks: **1,836**  &nbsp;&nbsp; `3,011 stars this week`
...
1. [cline / cline](https://github.com/cline/cline)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **22,112** &nbsp;&nbsp; folks: **1,906**  &nbsp;&nbsp; `2,409 stars this week`
...
1. [elizaOS / eliza](https://github.com/elizaOS/eliza)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **11,460** &nbsp;&nbsp; folks: **3,171**  &nbsp;&nbsp; `7,255 stars this month`
...
1. [cline / cline](https://github.com/cline/cline)
    - Autonomous coding agent right in your IDE, capable of creating/editing files, executing commands, using the browser, and more with your permission every step of the way.
    - language: **TypeScript** &nbsp;&nbsp; stars: **22,112** &nbsp;&nbsp; folks: **1,906**  &nbsp;&nbsp; `7,483 stars this month`
...
1. [Byaidu / PDFMathTranslate](https://github.com/Byaidu/PDFMathTranslate)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **15,109** &nbsp;&nbsp; folks: **1,132**  &nbsp;&nbsp; `9,799 stars this month`
...
1. [unclecode / crawl4ai](https://github.com/unclecode/crawl4ai)
    - 🚀🤖 Crawl4AI: Open-source LLM Friendly Web Crawler & Scraper
    - language: **Python** &nbsp;&nbsp; stars: **24,656** &nbsp;&nbsp; folks: **1,836**  &nbsp;&nbsp; `5,963 stars this month`
