...
`更新时间：2023-04-13 06:13:01 +0800`

## 今日热门仓库

1. [shadcn / taxonomy](https://github.com/shadcn/taxonomy)
    - An open source application built using the new router, server components and everything new in Next.js 13.
    - language: **TypeScript** &nbsp;&nbsp; stars: **7,209** &nbsp;&nbsp; folks: **633**  &nbsp;&nbsp; `630 stars today`

1. [reworkd / AgentGPT](https://github.com/reworkd/AgentGPT)
    - 🤖 Assemble, configure, and deploy autonomous AI Agents in your browser.
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,217** &nbsp;&nbsp; folks: **845**  &nbsp;&nbsp; `2,922 stars today`
...
1. [IDEA-Research / Grounded-Segment-Anything](https://github.com/IDEA-Research/Grounded-Segment-Anything)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **5,585** &nbsp;&nbsp; folks: **398**  &nbsp;&nbsp; `949 stars today`
...
1. [sail-sg / EditAnything](https://github.com/sail-sg/EditAnything)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **1,122** &nbsp;&nbsp; folks: **27**  &nbsp;&nbsp; `282 stars today`
...
1. [ravenscroftj / turbopilot](https://github.com/ravenscroftj/turbopilot)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **1,752** &nbsp;&nbsp; folks: **51**  &nbsp;&nbsp; `1,217 stars today`
...
1. [vinta / awesome-python](https://github.com/vinta/awesome-python)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **163,719** &nbsp;&nbsp; folks: **22,918**  &nbsp;&nbsp; `435 stars today`
...
1. [hemansnation / God-Level-Data-Science-ML-Full-Stack](https://github.com/hemansnation/God-Level-Data-Science-ML-Full-Stack)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **1,504** &nbsp;&nbsp; folks: **342**  &nbsp;&nbsp; `343 stars today`

1. [Torantulino / Auto-GPT](https://github.com/Torantulino/Auto-GPT)
    - An experimental open-source attempt to make GPT-4 fully autonomous.
    - language: **Python** &nbsp;&nbsp; stars: **33,711** &nbsp;&nbsp; folks: **4,363**  &nbsp;&nbsp; `8,170 stars today`
...
1. [oobabooga / text-generation-webui](https://github.com/oobabooga/text-generation-webui)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **7,755** &nbsp;&nbsp; folks: **738**  &nbsp;&nbsp; `269 stars today`
...
1. [base-org / node](https://github.com/base-org/node)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **30,804** &nbsp;&nbsp; folks: **700**  &nbsp;&nbsp; `840 stars today`
...
1. [Torantulino / Auto-GPT](https://github.com/Torantulino/Auto-GPT)
    - An experimental open-source attempt to make GPT-4 fully autonomous.
    - language: **Python** &nbsp;&nbsp; stars: **33,711** &nbsp;&nbsp; folks: **4,363**  &nbsp;&nbsp; `17,518 stars this week`

1. [yoheinakajima / babyagi](https://github.com/yoheinakajima/babyagi)
    - 无
    - language: **Python** &nbsp;&nbsp; stars: **7,650** &nbsp;&nbsp; folks: **975**  &nbsp;&nbsp; `5,276 stars this week`

1. [microsoft / JARVIS](https://github.com/microsoft/JARVIS)
    - JARVIS, a system to connect LLMs with ML community. Paper: https://arxiv.org/pdf/2303.17580.pdf
    - language: **Python** &nbsp;&nbsp; stars: **16,003** &nbsp;&nbsp; folks: **1,145**  &nbsp;&nbsp; `10,298 stars this week`
...
1. [shadcn / taxonomy](https://github.com/shadcn/taxonomy)
    - An open source application built using the new router, server components and everything new in Next.js 13.
    - language: **TypeScript** &nbsp;&nbsp; stars: **7,209** &nbsp;&nbsp; folks: **633**  &nbsp;&nbsp; `1,252 stars this week`

1. [nat / openplayground](https://github.com/nat/openplayground)
    - An LLM playground you can run on your laptop
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,437** &nbsp;&nbsp; folks: **193**  &nbsp;&nbsp; `1,445 stars this week`
...
1. [oobabooga / text-generation-webui](https://github.com/oobabooga/text-generation-webui)
    - A gradio web UI for running Large Language Models like LLaMA, llama.cpp, GPT-J, Pythia, OPT, and GALACTICA.
    - language: **Python** &nbsp;&nbsp; stars: **7,755** &nbsp;&nbsp; folks: **738**  &nbsp;&nbsp; `2,072 stars this week`
...
1. [THUDM / ChatGLM-6B](https://github.com/THUDM/ChatGLM-6B)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **16,706** &nbsp;&nbsp; folks: **1,915**  &nbsp;&nbsp; `16,597 stars this month`
...
1. [openai / evals](https://github.com/openai/evals)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **7,990** &nbsp;&nbsp; folks: **1,358**  &nbsp;&nbsp; `7,968 stars this month`
...
1. [oobabooga / text-generation-webui](https://github.com/oobabooga/text-generation-webui)
    - A gradio web UI for running Large Language Models like LLaMA, llama.cpp, GPT-J, Pythia, OPT, and GALACTICA.
    - language: **Python** &nbsp;&nbsp; stars: **7,755** &nbsp;&nbsp; folks: **738**  &nbsp;&nbsp; `5,431 stars this month`
...
1. [huggingface / peft](https://github.com/huggingface/peft)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **3,747** &nbsp;&nbsp; folks: **249**  &nbsp;&nbsp; `2,445 stars this month`

1. [dair-ai / Prompt-Engineering-Guide](https://github.com/dair-ai/Prompt-Engineering-Guide)
    - 🐙 Guides, papers, lecture, notebooks and resources for prompt engineering
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **24,279** &nbsp;&nbsp; folks: **1,962**  &nbsp;&nbsp; `10,885 stars this month`

1. [ggerganov / ggml](https://github.com/ggerganov/ggml)
    - Tensor library for machine learning
    - language: **C** &nbsp;&nbsp; stars: **1,370** &nbsp;&nbsp; folks: **102**  &nbsp;&nbsp; `1,036 stars this month`
