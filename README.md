...
1. [soimort / you-get](https://github.com/soimort/you-get)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **51,566** &nbsp;&nbsp; folks: **9,492**  &nbsp;&nbsp; `864 stars today`
...
1. [meta-llama / llama-recipes](https://github.com/meta-llama/llama-recipes)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **13,376** &nbsp;&nbsp; folks: **2,026**  &nbsp;&nbsp; `271 stars today`
...
1. [huggingface / lerobot](https://github.com/huggingface/lerobot)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **6,998** &nbsp;&nbsp; folks: **649**  &nbsp;&nbsp; `36 stars today`

1. [termux / termux-app](https://github.com/termux/termux-app)
    - Termux - a terminal emulator application for Android OS extendible by variety of packages.
    - language: **Java** &nbsp;&nbsp; stars: **35,863** &nbsp;&nbsp; folks: **3,769**  &nbsp;&nbsp; `30 stars today`
...
1. [hiteshchoudhary / apihub](https://github.com/hiteshchoudhary/apihub)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **6,248** &nbsp;&nbsp; folks: **1,059**  &nbsp;&nbsp; `2,248 stars this week`
...
1. [getomni-ai / zerox](https://github.com/getomni-ai/zerox)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **4,707** &nbsp;&nbsp; folks: **259**  &nbsp;&nbsp; `1,299 stars this week`

1. [anthropics / courses](https://github.com/anthropics/courses)
    - Anthropic's educational courses
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **6,403** &nbsp;&nbsp; folks: **500**  &nbsp;&nbsp; `573 stars this week`
...
1. [TheAlgorithms / Python](https://github.com/TheAlgorithms/Python)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **193,562** &nbsp;&nbsp; folks: **45,538**  &nbsp;&nbsp; `9,428 stars this month`
...
1. [TheAlgorithms / Java](https://github.com/TheAlgorithms/Java)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **59,842** &nbsp;&nbsp; folks: **19,333**  &nbsp;&nbsp; `1,137 stars this month`

1. [maybe-finance / maybe](https://github.com/maybe-finance/maybe)
    - The OS for your personal finances
    - language: **Ruby** &nbsp;&nbsp; stars: **31,854** &nbsp;&nbsp; folks: **2,343**  &nbsp;&nbsp; `2,336 stars this month`

1. [OpenBB-finance / OpenBB](https://github.com/OpenBB-finance/OpenBB)
    - Investment Research for Everyone, Everywhere.
    - language: **Python** &nbsp;&nbsp; stars: **33,356** &nbsp;&nbsp; folks: **3,047**  &nbsp;&nbsp; `3,044 stars this month`
...
1. [ToolJet / ToolJet](https://github.com/ToolJet/ToolJet)
    - Low-code platform for building business applications. Connect to databases, cloud storages, GraphQL, API endpoints, Airtable, Google sheets, OpenAI, etc and build apps using drag and drop application builder. Built using JavaScript/TypeScript. 🚀
    - language: **JavaScript** &nbsp;&nbsp; stars: **31,414** &nbsp;&nbsp; folks: **4,055**  &nbsp;&nbsp; `2,432 stars this month`
