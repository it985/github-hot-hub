...
1. [yangshun / tech-interview-handbook](https://github.com/yangshun/tech-interview-handbook)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **85,892** &nbsp;&nbsp; folks: **11,254**  &nbsp;&nbsp; `105 stars today`
...
1. [bitcoin / bitcoin](https://github.com/bitcoin/bitcoin)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **68,088** &nbsp;&nbsp; folks: **33,737**  &nbsp;&nbsp; `45 stars today`

1. [freeCodeCamp / freeCodeCamp](https://github.com/freeCodeCamp/freeCodeCamp)
    - freeCodeCamp.org's open-source codebase and curriculum. Learn to code for free.
    - language: **TypeScript** &nbsp;&nbsp; stars: **360,702** &nbsp;&nbsp; folks: **30,953**  &nbsp;&nbsp; `150 stars today`
...
1. [TheAlgorithms / JavaScript](https://github.com/TheAlgorithms/JavaScript)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **24,865** &nbsp;&nbsp; folks: **4,303**  &nbsp;&nbsp; `89 stars today`
...
1. [vasanthk / how-web-works](https://github.com/vasanthk/how-web-works)
    ...
    - language: **无** &nbsp;&nbsp; stars: **12,925** &nbsp;&nbsp; folks: **1,456**  &nbsp;&nbsp; `129 stars today`

1. [orlp / glidesort](https://github.com/orlp/glidesort)
    - A Rust implementation of Glidesort, my stable adaptive quicksort/mergesort hybrid sorting algorithm.
    - language: **Rust** &nbsp;&nbsp; stars: **1,080** &nbsp;&nbsp; folks: **19**  &nbsp;&nbsp; `175 stars today`

1. [microsoft / BioGPT](https://github.com/microsoft/BioGPT)
    - 无
    - language: **Python** &nbsp;&nbsp; stars: **1,323** &nbsp;&nbsp; folks: **125**  &nbsp;&nbsp; `266 stars today`
...
1. [fathyb / carbonyl](https://github.com/fathyb/carbonyl)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **9,681** &nbsp;&nbsp; folks: **223**  &nbsp;&nbsp; `5,290 stars this week`

1. [apitable / apitable](https://github.com/apitable/apitable)
    - 🚀🎉📚 APITable, an API-oriented low-code platform for building collaborative apps and better than all other Airtable open-source alternatives.
    - language: **TypeScript** &nbsp;&nbsp; stars: **6,266** &nbsp;&nbsp; folks: **345**  &nbsp;&nbsp; `3,887 stars this week`
...
1. [LAION-AI / Open-Assistant](https://github.com/LAION-AI/Open-Assistant)
    - OpenAssistant is a chat-based assistant that understands tasks, can interact with third-party systems, and retrieve information dynamically to do so.
    - language: **Python** &nbsp;&nbsp; stars: **11,646** &nbsp;&nbsp; folks: **845**  &nbsp;&nbsp; `5,425 stars this week`

1. [localsend / localsend](https://github.com/localsend/localsend)
    - An open source cross-platform alternative to AirDrop
    - language: **Dart** &nbsp;&nbsp; stars: **5,052** &nbsp;&nbsp; folks: **257**  &nbsp;&nbsp; `2,268 stars this week`
...
1. [bregman-arie / devops-exercises](https://github.com/bregman-arie/devops-exercises)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **39,472** &nbsp;&nbsp; folks: **8,669**  &nbsp;&nbsp; `2,138 stars this week`

1. [lencx / ChatGPT](https://github.com/lencx/ChatGPT)
    - 🔮 ChatGPT Desktop Application (Mac, Windows and Linux)
    - language: **Rust** &nbsp;&nbsp; stars: **9,594** &nbsp;&nbsp; folks: **758**  &nbsp;&nbsp; `2,526 stars this week`
...
1. [initialcommit-com / git-sim](https://github.com/initialcommit-com/git-sim)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **2,872** &nbsp;&nbsp; folks: **79**  &nbsp;&nbsp; `839 stars this week`
...
1. [karpathy / nanoGPT](https://github.com/karpathy/nanoGPT)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **11,831** &nbsp;&nbsp; folks: **914**  &nbsp;&nbsp; `9,066 stars this month`

1. [DataTalksClub / data-engineering-zoomcamp](https://github.com/DataTalksClub/data-engineering-zoomcamp)
    - Free Data Engineering course!
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **11,917** &nbsp;&nbsp; folks: **2,617**  &nbsp;&nbsp; `4,283 stars this month`
...
1. [lencx / ChatGPT](https://github.com/lencx/ChatGPT)
    - 🔮 ChatGPT Desktop Application (Mac, Windows and Linux)
    - language: **Rust** &nbsp;&nbsp; stars: **9,594** &nbsp;&nbsp; folks: **758**  &nbsp;&nbsp; `5,799 stars this month`

1. [LAION-AI / Open-Assistant](https://github.com/LAION-AI/Open-Assistant)
    - OpenAssistant is a chat-based assistant that understands tasks, can interact with third-party systems, and retrieve information dynamically to do so.
    - language: **Python** &nbsp;&nbsp; stars: **11,646** &nbsp;&nbsp; folks: **845**  &nbsp;&nbsp; `8,231 stars this month`
...
1. [hwchase17 / langchain](https://github.com/hwchase17/langchain)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **5,835** &nbsp;&nbsp; folks: **471**  &nbsp;&nbsp; `4,209 stars this month`
...
1. [apitable / apitable](https://github.com/apitable/apitable)
    - 🚀🎉📚 APITable, an API-oriented low-code platform for building collaborative apps and better than all other Airtable open-source alternatives.
    - language: **TypeScript** &nbsp;&nbsp; stars: **6,266** &nbsp;&nbsp; folks: **345**  &nbsp;&nbsp; `4,189 stars this month`

1. [sourcegraph / conc](https://github.com/sourcegraph/conc)
    - Better structured concurrency for go
    - language: **Go** &nbsp;&nbsp; stars: **5,540** &nbsp;&nbsp; folks: **164**  &nbsp;&nbsp; `3,898 stars this month`
