...
`更新时间：2023-01-28 13:13:24 +0800`

## 今日热门仓库

1. [shadcn / ui](https://github.com/shadcn/ui)
    - Beautifully designed components built with Radix UI and Tailwind CSS.
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,781** &nbsp;&nbsp; folks: **183**  &nbsp;&nbsp; `1,235 stars today`
...
1. [AzeemIdrisi / PhoneSploit-Pro](https://github.com/AzeemIdrisi/PhoneSploit-Pro)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **424** &nbsp;&nbsp; folks: **67**  &nbsp;&nbsp; `178 stars today`

1. [trekhleb / javascript-algorithms](https://github.com/trekhleb/javascript-algorithms)
    - 📝 Algorithms and data structures implemented in JavaScript with explanations and links to further readings
    - language: **JavaScript** &nbsp;&nbsp; stars: **161,592** &nbsp;&nbsp; folks: **26,731**  &nbsp;&nbsp; `237 stars today`

1. [LAION-AI / Open-Assistant](https://github.com/LAION-AI/Open-Assistant)
    - OpenAssistant is a chat-based assistant that understands tasks, can interact with third-party systems, and retrieve information dynamically to do so.
    - language: **Python** &nbsp;&nbsp; stars: **5,314** &nbsp;&nbsp; folks: **450**  &nbsp;&nbsp; `229 stars today`
...
1. [HexRaysSA / goomba](https://github.com/HexRaysSA/goomba)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **236** &nbsp;&nbsp; folks: **16**  &nbsp;&nbsp; `50 stars today`
...
1. [localsend / localsend](https://github.com/localsend/localsend)
    ...
    - language: **Dart** &nbsp;&nbsp; stars: **686** &nbsp;&nbsp; folks: **18**  &nbsp;&nbsp; `152 stars today`
...
1. [dortania / OpenCore-Legacy-Patcher](https://github.com/dortania/OpenCore-Legacy-Patcher)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **5,178** &nbsp;&nbsp; folks: **555**  &nbsp;&nbsp; `46 stars today`
...
1. [jlevy / the-art-of-command-line](https://github.com/jlevy/the-art-of-command-line)
    ...
    - language: **无** &nbsp;&nbsp; stars: **126,836** &nbsp;&nbsp; folks: **12,845**  &nbsp;&nbsp; `196 stars today`

1. [ripienaar / free-for-dev](https://github.com/ripienaar/free-for-dev)
    - A list of SaaS, PaaS and IaaS offerings that have free tiers of interest to devops and infradev
    - language: **HTML** &nbsp;&nbsp; stars: **66,191** &nbsp;&nbsp; folks: **7,192**  &nbsp;&nbsp; `99 stars today`
...
1. [dotnet / efcore](https://github.com/dotnet/efcore)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **12,137** &nbsp;&nbsp; folks: **2,882**  &nbsp;&nbsp; `13 stars today`

1. [trufflesecurity / trufflehog](https://github.com/trufflesecurity/trufflehog)
    - Find credentials all over the place
    - language: **Go** &nbsp;&nbsp; stars: **10,264** &nbsp;&nbsp; folks: **1,236**  &nbsp;&nbsp; `38 stars today`

1. [facebook / jest](https://github.com/facebook/jest)
    - Delightful JavaScript Testing.
    - language: **TypeScript** &nbsp;&nbsp; stars: **41,259** &nbsp;&nbsp; folks: **6,238**  &nbsp;&nbsp; `25 stars today`
...
1. [Mokshit06 / typewind](https://github.com/Mokshit06/typewind)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **1,297** &nbsp;&nbsp; folks: **14**  &nbsp;&nbsp; `260 stars today`

1. [bridgecrewio / checkov](https://github.com/bridgecrewio/checkov)
    - Prevent cloud misconfigurations and find vulnerabilities during build-time in infrastructure as code, container images and open source packages with Checkov by Bridgecrew.
    - language: **Python** &nbsp;&nbsp; stars: **5,191** &nbsp;&nbsp; folks: **792**  &nbsp;&nbsp; `28 stars today`
...
1. [trekhleb / javascript-algorithms](https://github.com/trekhleb/javascript-algorithms)
    - 📝 Algorithms and data structures implemented in JavaScript with explanations and links to further readings
    - language: **JavaScript** &nbsp;&nbsp; stars: **161,592** &nbsp;&nbsp; folks: **26,731**  &nbsp;&nbsp; `2,473 stars this week`
...
1. [google-research / tuning_playbook](https://github.com/google-research/tuning_playbook)
    ...
    - language: **无** &nbsp;&nbsp; stars: **11,807** &nbsp;&nbsp; folks: **790**  &nbsp;&nbsp; `6,639 stars this week`
...
1. [LAION-AI / Open-Assistant](https://github.com/LAION-AI/Open-Assistant)
    - OpenAssistant is a chat-based assistant that understands tasks, can interact with third-party systems, and retrieve information dynamically to do so.
    - language: **Python** &nbsp;&nbsp; stars: **5,314** &nbsp;&nbsp; folks: **450**  &nbsp;&nbsp; `4,685 stars this month`

1. [brycedrennan / imaginAIry](https://github.com/brycedrennan/imaginAIry)
    - AI imagined images. Pythonic generation of stable diffusion images.
    - language: **Python** &nbsp;&nbsp; stars: **5,555** &nbsp;&nbsp; folks: **246**  &nbsp;&nbsp; `4,027 stars this month`

1. [lencx / ChatGPT](https://github.com/lencx/ChatGPT)
    - 🔮 ChatGPT Desktop Application (Mac, Windows and Linux)
    - language: **Rust** &nbsp;&nbsp; stars: **6,413** &nbsp;&nbsp; folks: **496**  &nbsp;&nbsp; `4,661 stars this month`
...
1. [f / awesome-chatgpt-prompts](https://github.com/f/awesome-chatgpt-prompts)
    ...
    - language: **HTML** &nbsp;&nbsp; stars: **18,583** &nbsp;&nbsp; folks: **1,698**  &nbsp;&nbsp; `8,223 stars this month`
