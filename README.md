...
`更新时间：2025-04-17 11:02:57 +0800`

## 今日热门仓库

1. [virattt / ai-hedge-fund](https://github.com/virattt/ai-hedge-fund)
    - An AI Hedge Fund Team
    - language: **Python** &nbsp;&nbsp; stars: **24,280** &nbsp;&nbsp; folks: **4,216**  &nbsp;&nbsp; `1,590 stars today`

1. [Anduin2017 / HowToCook](https://github.com/Anduin2017/HowToCook)
    - 程序员在家做饭方法指南。Programmer's guide about how to cook at home (Simplified Chinese only).
    - language: **Dockerfile** &nbsp;&nbsp; stars: **73,036** &nbsp;&nbsp; folks: **9,079**  &nbsp;&nbsp; `1,010 stars today`
...
1. [Anxcye / anx-reader](https://github.com/Anxcye/anx-reader)
    ...
    - language: **Dart** &nbsp;&nbsp; stars: **4,069** &nbsp;&nbsp; folks: **214**  &nbsp;&nbsp; `133 stars today`
...
1. [fuma-nama / fumadocs](https://github.com/fuma-nama/fumadocs)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,953** &nbsp;&nbsp; folks: **269**  &nbsp;&nbsp; `574 stars today`

1. [DioxusLabs / dioxus](https://github.com/DioxusLabs/dioxus)
    - Fullstack app framework for web, desktop, mobile, and more.
    - language: **Rust** &nbsp;&nbsp; stars: **26,735** &nbsp;&nbsp; folks: **1,058**  &nbsp;&nbsp; `51 stars today`
...
1. [yeongpin / cursor-free-vip](https://github.com/yeongpin/cursor-free-vip)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **18,086** &nbsp;&nbsp; folks: **2,161**  &nbsp;&nbsp; `1,032 stars today`
...
1. [svcvit / Awesome-Dify-Workflow](https://github.com/svcvit/Awesome-Dify-Workflow)
    ...
    - language: **无** &nbsp;&nbsp; stars: **5,988** &nbsp;&nbsp; folks: **591**  &nbsp;&nbsp; `394 stars today`
...
1. [kestra-io / kestra](https://github.com/kestra-io/kestra)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **17,141** &nbsp;&nbsp; folks: **1,449**  &nbsp;&nbsp; `76 stars today`
...
1. [yeongpin / cursor-free-vip](https://github.com/yeongpin/cursor-free-vip)
    - [Support 0.48.x]（Reset Cursor AI MachineID & Bypass Higher Token Limit） Cursor Ai ，自动重置机器ID ， 免费升级使用Pro功能: You've reached your trial request limit. / Too many free trial accounts used on this machine. Please upgrade to pro. We have this limit in place to prevent abuse. Please let us know if you believe this is a mistake.
    - language: **Python** &nbsp;&nbsp; stars: **18,086** &nbsp;&nbsp; folks: **2,161**  &nbsp;&nbsp; `10,598 stars this week`
...
1. [funstory-ai / BabelDOC](https://github.com/funstory-ai/BabelDOC)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **2,452** &nbsp;&nbsp; folks: **134**  &nbsp;&nbsp; `1,133 stars this week`
...
1. [kestra-io / kestra](https://github.com/kestra-io/kestra)
    - ⚡ Workflow Automation Platform. Orchestrate & Schedule code in any language, run anywhere, 600+ plugins. Alternative to Airflow, VMware vRealize Automation, Rundeck...
    - language: **Java** &nbsp;&nbsp; stars: **17,141** &nbsp;&nbsp; folks: **1,449**  &nbsp;&nbsp; `231 stars this week`
...
1. [yeongpin / cursor-free-vip](https://github.com/yeongpin/cursor-free-vip)
    - [Support 0.48.x]（Reset Cursor AI MachineID & Bypass Higher Token Limit） Cursor Ai ，自动重置机器ID ， 免费升级使用Pro功能: You've reached your trial request limit. / Too many free trial accounts used on this machine. Please upgrade to pro. We have this limit in place to prevent abuse. Please let us know if you believe this is a mistake.
    - language: **Python** &nbsp;&nbsp; stars: **18,086** &nbsp;&nbsp; folks: **2,161**  &nbsp;&nbsp; `15,200 stars this month`

1. [punkpeye / awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers)
    - A collection of MCP servers.
    - language: **无** &nbsp;&nbsp; stars: **38,724** &nbsp;&nbsp; folks: **2,746**  &nbsp;&nbsp; `28,848 stars this month`
...
1. [n8n-io / n8n](https://github.com/n8n-io/n8n)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **81,967** &nbsp;&nbsp; folks: **21,897**  &nbsp;&nbsp; `14,388 stars this month`
