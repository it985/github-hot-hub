...
`更新时间：2024-12-23 10:51:00 +0800`

## 今日热门仓库

1. [nicbarker / clay](https://github.com/nicbarker/clay)
    - High performance UI layout library in C.
    - language: **C** &nbsp;&nbsp; stars: **5,619** &nbsp;&nbsp; folks: **149**  &nbsp;&nbsp; `1,544 stars today`

1. [donnemartin / system-design-primer](https://github.com/donnemartin/system-design-primer)
    - Learn how to design large-scale systems. Prep for the system design interview. Includes Anki flashcards.
    - language: **Python** &nbsp;&nbsp; stars: **281,196** &nbsp;&nbsp; folks: **47,062**  &nbsp;&nbsp; `418 stars today`

1. [Genesis-Embodied-AI / Genesis](https://github.com/Genesis-Embodied-AI/Genesis)
    - A generative world for general-purpose robotics & embodied AI learning.
    - language: **Python** &nbsp;&nbsp; stars: **17,767** &nbsp;&nbsp; folks: **1,253**  &nbsp;&nbsp; `1,337 stars today`

1. [tldraw / tldraw](https://github.com/tldraw/tldraw)
    - whiteboard / infinite canvas SDK
    - language: **TypeScript** &nbsp;&nbsp; stars: **37,082** &nbsp;&nbsp; folks: **2,268**  &nbsp;&nbsp; `305 stars today`
...
1. [Helicone / helicone](https://github.com/Helicone/helicone)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,615** &nbsp;&nbsp; folks: **279**  &nbsp;&nbsp; `26 stars today`
...
1. [browserbase / stagehand](https://github.com/browserbase/stagehand)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,108** &nbsp;&nbsp; folks: **87**  &nbsp;&nbsp; `116 stars today`

1. [shardeum / shardeum](https://github.com/shardeum/shardeum)
    - Shardeum is an EVM based autoscaling blockchain
    - language: **TypeScript** &nbsp;&nbsp; stars: **25,793** &nbsp;&nbsp; folks: **488**  &nbsp;&nbsp; `796 stars today`
...
1. [Byaidu / PDFMathTranslate](https://github.com/Byaidu/PDFMathTranslate)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **10,409** &nbsp;&nbsp; folks: **725**  &nbsp;&nbsp; `3,590 stars this week`
...
1. [shardeum / shardeum](https://github.com/shardeum/shardeum)
    - Shardeum is an EVM based autoscaling blockchain
    - language: **TypeScript** &nbsp;&nbsp; stars: **25,793** &nbsp;&nbsp; folks: **488**  &nbsp;&nbsp; `4,230 stars this week`
...
1. [PatrickJS / awesome-cursorrules](https://github.com/PatrickJS/awesome-cursorrules)
    ...
    - language: **无** &nbsp;&nbsp; stars: **4,147** &nbsp;&nbsp; folks: **242**  &nbsp;&nbsp; `455 stars this week`
...
1. [Byaidu / PDFMathTranslate](https://github.com/Byaidu/PDFMathTranslate)
    - PDF scientific paper translation with preserved formats - 基于 AI 完整保留排版的 PDF 文档全文双语翻译，支持 Google/DeepL/Ollama/OpenAI 等服务，提供 CLI/GUI/Docker
    - language: **Python** &nbsp;&nbsp; stars: **10,409** &nbsp;&nbsp; folks: **725**  &nbsp;&nbsp; `7,629 stars this month`
