...
`更新时间：2025-01-30 22:16:27 +0800`

## 今日热门仓库

1. [block / goose](https://github.com/block/goose)
    - an open-source, extensible AI agent that goes beyond code suggestions - install, execute, edit, and test with any LLM
    - language: **Rust** &nbsp;&nbsp; stars: **2,411** &nbsp;&nbsp; folks: **184**  &nbsp;&nbsp; `746 stars today`

1. [QwenLM / Qwen2.5](https://github.com/QwenLM/Qwen2.5)
    - Qwen2.5 is the large language model series developed by Qwen team, Alibaba Cloud.
    - language: **Shell** &nbsp;&nbsp; stars: **12,730** &nbsp;&nbsp; folks: **805**  &nbsp;&nbsp; `299 stars today`
...
1. [deepseek-ai / DeepSeek-Coder](https://github.com/deepseek-ai/DeepSeek-Coder)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **15,683** &nbsp;&nbsp; folks: **1,572**  &nbsp;&nbsp; `681 stars today`

1. [ollama / ollama](https://github.com/ollama/ollama)
    - Get up and running with Llama 3.3, DeepSeek-R1, Phi-4, Gemma 2, and other large language models.
    - language: **Go** &nbsp;&nbsp; stars: **115,080** &nbsp;&nbsp; folks: **9,171**  &nbsp;&nbsp; `1,155 stars today`

1. [deepseek-ai / Janus](https://github.com/deepseek-ai/Janus)
    - Janus-Series: Unified Multimodal Understanding and Generation Models
    - language: **Python** &nbsp;&nbsp; stars: **12,357** &nbsp;&nbsp; folks: **1,441**  &nbsp;&nbsp; `3,045 stars today`

1. [deepseek-ai / DeepSeek-Math](https://github.com/deepseek-ai/DeepSeek-Math)
    - DeepSeekMath: Pushing the Limits of Mathematical Reasoning in Open Language Models
    - language: **Python** &nbsp;&nbsp; stars: **1,828** &nbsp;&nbsp; folks: **300**  &nbsp;&nbsp; `214 stars today`
...
1. [github / docs](https://github.com/github/docs)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **16,683** &nbsp;&nbsp; folks: **60,687**  &nbsp;&nbsp; `11 stars today`
...
1. [QwenLM / Qwen2.5-VL](https://github.com/QwenLM/Qwen2.5-VL)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **5,102** &nbsp;&nbsp; folks: **348**  &nbsp;&nbsp; `381 stars today`
...
1. [deepseek-ai / DeepSeek-Coder](https://github.com/deepseek-ai/DeepSeek-Coder)
    - DeepSeek Coder: Let the Code Write Itself
    - language: **Python** &nbsp;&nbsp; stars: **15,683** &nbsp;&nbsp; folks: **1,572**  &nbsp;&nbsp; `4,591 stars this week`
...
1. [ollama / ollama](https://github.com/ollama/ollama)
    - Get up and running with Llama 3.3, DeepSeek-R1, Phi-4, Gemma 2, and other large language models.
    - language: **Go** &nbsp;&nbsp; stars: **115,080** &nbsp;&nbsp; folks: **9,171**  &nbsp;&nbsp; `4,934 stars this week`
...
1. [open-webui / open-webui](https://github.com/open-webui/open-webui)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **63,151** &nbsp;&nbsp; folks: **7,572**  &nbsp;&nbsp; `4,474 stars this week`
...
1. [AmruthPillai / Reactive-Resume](https://github.com/AmruthPillai/Reactive-Resume)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **29,082** &nbsp;&nbsp; folks: **2,923**  &nbsp;&nbsp; `1,429 stars this week`
...
1. [QwenLM / Qwen2.5-VL](https://github.com/QwenLM/Qwen2.5-VL)
    - Qwen2.5-VL is the multimodal large language model series developed by Qwen team, Alibaba Cloud.
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **5,102** &nbsp;&nbsp; folks: **348**  &nbsp;&nbsp; `726 stars this week`
...
1. [angular / angular](https://github.com/angular/angular)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **96,757** &nbsp;&nbsp; folks: **25,805**  &nbsp;&nbsp; `138 stars this week`
...
1. [deepseek-ai / DeepSeek-Coder](https://github.com/deepseek-ai/DeepSeek-Coder)
    - DeepSeek Coder: Let the Code Write Itself
    - language: **Python** &nbsp;&nbsp; stars: **15,683** &nbsp;&nbsp; folks: **1,572**  &nbsp;&nbsp; `7,837 stars this month`
...
1. [open-webui / open-webui](https://github.com/open-webui/open-webui)
    - User-friendly AI Interface (Supports Ollama, OpenAI API, ...)
    - language: **JavaScript** &nbsp;&nbsp; stars: **63,151** &nbsp;&nbsp; folks: **7,572**  &nbsp;&nbsp; `9,374 stars this month`
