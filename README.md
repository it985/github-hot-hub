...
`更新时间：2023-03-31 05:12:20 +0800`

## 今日热门仓库

1. [hpcaitech / ColossalAI](https://github.com/hpcaitech/ColossalAI)
    - Making large AI models cheaper, faster and more accessible
    - language: **Python** &nbsp;&nbsp; stars: **23,567** &nbsp;&nbsp; folks: **2,644**  &nbsp;&nbsp; `2,184 stars today`

1. [binary-husky / chatgpt_academic](https://github.com/binary-husky/chatgpt_academic)
    - 科研工作专用ChatGPT拓展，特别优化学术Paper润色体验，支持自定义快捷按钮，支持markdown表格显示，Tex公式双显示，代码显示功能完善，新增本地Python工程剖析功能/自我剖析功能
    - language: **Python** &nbsp;&nbsp; stars: **13,625** &nbsp;&nbsp; folks: **1,252**  &nbsp;&nbsp; `3,682 stars today`
...
1. [Yidadaa / ChatGPT-Next-Web](https://github.com/Yidadaa/ChatGPT-Next-Web)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,778** &nbsp;&nbsp; folks: **2,143**  &nbsp;&nbsp; `1,845 stars today`
...
1. [Bin-Huang / chatbox](https://github.com/Bin-Huang/chatbox)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,948** &nbsp;&nbsp; folks: **369**  &nbsp;&nbsp; `743 stars today`
...
1. [showlab / Tune-A-Video](https://github.com/showlab/Tune-A-Video)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **2,316** &nbsp;&nbsp; folks: **167**  &nbsp;&nbsp; `492 stars today`

1. [Kent0n-Li / ChatDoctor](https://github.com/Kent0n-Li/ChatDoctor)
    - 无
    - language: **Python** &nbsp;&nbsp; stars: **1,278** &nbsp;&nbsp; folks: **121**  &nbsp;&nbsp; `320 stars today`

1. [nomic-ai / gpt4all](https://github.com/nomic-ai/gpt4all)
    - gpt4all: a chatbot trained on a massive collection of clean assistant data including code, stories and dialogue
    - language: **Python** &nbsp;&nbsp; stars: **11,159** &nbsp;&nbsp; folks: **868**  &nbsp;&nbsp; `5,120 stars today`
...
1. [getcursor / cursor](https://github.com/getcursor/cursor)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **10,444** &nbsp;&nbsp; folks: **683**  &nbsp;&nbsp; `1,615 stars today`
...
1. [mouredev / Hello-Python](https://github.com/mouredev/Hello-Python)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **10,276** &nbsp;&nbsp; folks: **717**  &nbsp;&nbsp; `179 stars today`
...
1. [ryanmcdermott / clean-code-javascript](https://github.com/ryanmcdermott/clean-code-javascript)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **80,917** &nbsp;&nbsp; folks: **10,961**  &nbsp;&nbsp; `99 stars today`
...
1. [mckaywrigley / chatbot-ui](https://github.com/mckaywrigley/chatbot-ui)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,605** &nbsp;&nbsp; folks: **1,063**  &nbsp;&nbsp; `3,445 stars this week`
...
1. [PlexPt / awesome-chatgpt-prompts-zh](https://github.com/PlexPt/awesome-chatgpt-prompts-zh)
    ...
    - language: **无** &nbsp;&nbsp; stars: **25,106** &nbsp;&nbsp; folks: **7,620**  &nbsp;&nbsp; `5,341 stars this week`

1. [Bin-Huang / chatbox](https://github.com/Bin-Huang/chatbox)
    - A desktop app for ChatGPT API (OpenAI API) that supports Windows, Mac & Linux. 开源的ChatGPT桌面应用，prompt 开发神器，全平台支持，下载安装包就能用
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,948** &nbsp;&nbsp; folks: **369**  &nbsp;&nbsp; `1,990 stars this week`
...
1. [jerryjliu / llama_index](https://github.com/jerryjliu/llama_index)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **9,761** &nbsp;&nbsp; folks: **911**  &nbsp;&nbsp; `1,565 stars this week`
...
1. [facebookresearch / llama](https://github.com/facebookresearch/llama)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **15,160** &nbsp;&nbsp; folks: **2,373**  &nbsp;&nbsp; `9,824 stars this month`
...
1. [AUTOMATIC1111 / stable-diffusion-webui](https://github.com/AUTOMATIC1111/stable-diffusion-webui)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **55,941** &nbsp;&nbsp; folks: **10,354**  &nbsp;&nbsp; `14,685 stars this month`

1. [ggerganov / whisper.cpp](https://github.com/ggerganov/whisper.cpp)
    - Port of OpenAI's Whisper model in C/C++
    - language: **C** &nbsp;&nbsp; stars: **13,870** &nbsp;&nbsp; folks: **1,112**  &nbsp;&nbsp; `6,559 stars this month`
...
1. [hwchase17 / langchain](https://github.com/hwchase17/langchain)
    - ⚡ Building applications with LLMs through composability ⚡
    - language: **Python** &nbsp;&nbsp; stars: **18,086** &nbsp;&nbsp; folks: **1,603**  &nbsp;&nbsp; `9,788 stars this month`

1. [openai / openai-cookbook](https://github.com/openai/openai-cookbook)
    - Examples and guides for using the OpenAI API
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **23,938** &nbsp;&nbsp; folks: **3,341**  &nbsp;&nbsp; `10,184 stars this month`
...
1. [f / awesome-chatgpt-prompts](https://github.com/f/awesome-chatgpt-prompts)
    - This repo includes ChatGPT prompt curation to use ChatGPT better.
    - language: **HTML** &nbsp;&nbsp; stars: **56,572** &nbsp;&nbsp; folks: **6,696**  &nbsp;&nbsp; `23,211 stars this month`
...
1. [jerryjliu / llama_index](https://github.com/jerryjliu/llama_index)
    - LlamaIndex (GPT Index) is a project that provides a central interface to connect your LLM's with external data.
    - language: **Python** &nbsp;&nbsp; stars: **9,761** &nbsp;&nbsp; folks: **911**  &nbsp;&nbsp; `5,293 stars this month`
