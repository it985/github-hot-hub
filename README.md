...
1. [srbhr / Resume-Matcher](https://github.com/srbhr/Resume-Matcher)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **7,295** &nbsp;&nbsp; folks: **2,593**  &nbsp;&nbsp; `486 stars today`
...
1. [feder-cr / Jobs_Applier_AI_Agent](https://github.com/feder-cr/Jobs_Applier_AI_Agent)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **24,673** &nbsp;&nbsp; folks: **3,661**  &nbsp;&nbsp; `176 stars today`

1. [browserbase / stagehand](https://github.com/browserbase/stagehand)
    - An AI web browsing framework focused on simplicity and extensibility.
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,055** &nbsp;&nbsp; folks: **166**  &nbsp;&nbsp; `662 stars today`
...
1. [inkonchain / docs](https://github.com/inkonchain/docs)
    - Ink Documentation
    - language: **MDX** &nbsp;&nbsp; stars: **19,793** &nbsp;&nbsp; folks: **212**  &nbsp;&nbsp; `2,365 stars today`

1. [inkonchain / node](https://github.com/inkonchain/node)
    - How to run an Ink Node
    - language: **Shell** &nbsp;&nbsp; stars: **19,861** &nbsp;&nbsp; folks: **300**  &nbsp;&nbsp; `2,373 stars today`
...
1. [zaidmukaddam / miniperplx](https://github.com/zaidmukaddam/miniperplx)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,197** &nbsp;&nbsp; folks: **348**  &nbsp;&nbsp; `1,848 stars this week`
...
1. [cline / cline](https://github.com/cline/cline)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **21,216** &nbsp;&nbsp; folks: **1,805**  &nbsp;&nbsp; `2,409 stars this week`
...
1. [mudler / LocalAI](https://github.com/mudler/LocalAI)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **28,100** &nbsp;&nbsp; folks: **2,116**  &nbsp;&nbsp; `616 stars this week`
...
1. [cline / cline](https://github.com/cline/cline)
    - Autonomous coding agent right in your IDE, capable of creating/editing files, executing commands, using the browser, and more with your permission every step of the way.
    - language: **TypeScript** &nbsp;&nbsp; stars: **21,216** &nbsp;&nbsp; folks: **1,805**  &nbsp;&nbsp; `6,941 stars this month`
...
1. [OpenSPG / KAG](https://github.com/OpenSPG/KAG)
    - KAG is a logical form-guided reasoning and retrieval framework based on OpenSPG engine and LLMs. It is used to build logical reasoning and factual Q&A solutions for professional domain knowledge bases. It can effectively overcome the shortcomings of the traditional RAG vector similarity calculation model.
    - language: **Python** &nbsp;&nbsp; stars: **3,809** &nbsp;&nbsp; folks: **229**  &nbsp;&nbsp; `2,941 stars this month`
...
1. [sxyazi / yazi](https://github.com/sxyazi/yazi)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **20,472** &nbsp;&nbsp; folks: **456**  &nbsp;&nbsp; `3,168 stars this month`
