...
1. [microsoft / OmniParser](https://github.com/microsoft/OmniParser)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **15,386** &nbsp;&nbsp; folks: **1,164**  &nbsp;&nbsp; `1,795 stars today`
...
1. [hpcaitech / ColossalAI](https://github.com/hpcaitech/ColossalAI)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **40,145** &nbsp;&nbsp; folks: **4,455**  &nbsp;&nbsp; `255 stars today`
...
1. [wangrongding / wechat-bot](https://github.com/wangrongding/wechat-bot)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **6,856** &nbsp;&nbsp; folks: **889**  &nbsp;&nbsp; `54 stars today`
...
1. [lucide-icons / lucide](https://github.com/lucide-icons/lucide)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **14,891** &nbsp;&nbsp; folks: **662**  &nbsp;&nbsp; `64 stars today`

1. [mastra-ai / mastra](https://github.com/mastra-ai/mastra)
    - the TypeScript AI agent framework
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,886** &nbsp;&nbsp; folks: **98**  &nbsp;&nbsp; `773 stars today`

1. [microsoft / TinyTroupe](https://github.com/microsoft/TinyTroupe)
    - LLM-powered multiagent persona simulation for imagination enhancement and business insights.
    - language: **Python** &nbsp;&nbsp; stars: **5,783** &nbsp;&nbsp; folks: **463**  &nbsp;&nbsp; `47 stars today`
...
1. [jingyaogong / minimind](https://github.com/jingyaogong/minimind)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **11,255** &nbsp;&nbsp; folks: **1,178**  &nbsp;&nbsp; `493 stars today`

1. [spf13 / cobra](https://github.com/spf13/cobra)
    - A Commander for modern Go CLI interactions
    - language: **Go** &nbsp;&nbsp; stars: **39,436** &nbsp;&nbsp; folks: **2,892**  &nbsp;&nbsp; `74 stars today`
...
1. [microsoft / OmniParser](https://github.com/microsoft/OmniParser)
    - A simple screen parsing tool towards pure vision based GUI agent
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **15,387** &nbsp;&nbsp; folks: **1,164**  &nbsp;&nbsp; `9,283 stars this week`
...
1. [langgenius / dify](https://github.com/langgenius/dify)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **70,231** &nbsp;&nbsp; folks: **10,229**  &nbsp;&nbsp; `3,460 stars this week`
...
1. [jingyaogong / minimind](https://github.com/jingyaogong/minimind)
    - 🚀🚀 「大模型」2小时完全从0训练26M的小参数GPT！🌏 Train a 26M-parameter GPT from scratch in just 2h!
    - language: **Python** &nbsp;&nbsp; stars: **11,255** &nbsp;&nbsp; folks: **1,178**  &nbsp;&nbsp; `2,223 stars this week`

1. [microsoft / markitdown](https://github.com/microsoft/markitdown)
    - Python tool for converting files and office documents to Markdown.
    - language: **HTML** &nbsp;&nbsp; stars: **38,260** &nbsp;&nbsp; folks: **1,764**  &nbsp;&nbsp; `1,502 stars this week`
...
1. [infiniflow / ragflow](https://github.com/infiniflow/ragflow)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **38,291** &nbsp;&nbsp; folks: **3,392**  &nbsp;&nbsp; `2,681 stars this week`
...
1. [labring / FastGPT](https://github.com/labring/FastGPT)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **21,479** &nbsp;&nbsp; folks: **5,524**  &nbsp;&nbsp; `662 stars this week`
...
1. [microsoft / OmniParser](https://github.com/microsoft/OmniParser)
    - A simple screen parsing tool towards pure vision based GUI agent
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **15,387** &nbsp;&nbsp; folks: **1,164**  &nbsp;&nbsp; `9,432 stars this month`
...
1. [ollama / ollama](https://github.com/ollama/ollama)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **128,137** &nbsp;&nbsp; folks: **10,429**  &nbsp;&nbsp; `19,909 stars this month`

1. [open-webui / open-webui](https://github.com/open-webui/open-webui)
    - User-friendly AI Interface (Supports Ollama, OpenAI API, ...)
    - language: **JavaScript** &nbsp;&nbsp; stars: **77,053** &nbsp;&nbsp; folks: **9,136**  &nbsp;&nbsp; `19,842 stars this month`
...
1. [browser-use / browser-use](https://github.com/browser-use/browser-use)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **30,166** &nbsp;&nbsp; folks: **3,124**  &nbsp;&nbsp; `14,912 stars this month`
...
1. [langgenius / dify](https://github.com/langgenius/dify)
    - Dify is an open-source LLM app development platform. Dify's intuitive interface combines AI workflow, RAG pipeline, agent capabilities, model management, observability features and more, letting you quickly go from prototype to production.
    - language: **TypeScript** &nbsp;&nbsp; stars: **70,231** &nbsp;&nbsp; folks: **10,229**  &nbsp;&nbsp; `10,899 stars this month`
