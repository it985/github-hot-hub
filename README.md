...
1. [louis-e / arnis](https://github.com/louis-e/arnis)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **2,463** &nbsp;&nbsp; folks: **47**  &nbsp;&nbsp; `560 stars today`

1. [deepseek-ai / DeepSeek-Coder](https://github.com/deepseek-ai/DeepSeek-Coder)
    - DeepSeek Coder: Let the Code Write Itself
    - language: **Python** &nbsp;&nbsp; stars: **9,104** &nbsp;&nbsp; folks: **601**  &nbsp;&nbsp; `1,336 stars today`

1. [black-forest-labs / flux](https://github.com/black-forest-labs/flux)
    - Official inference repo for FLUX.1 models
    - language: **Python** &nbsp;&nbsp; stars: **18,966** &nbsp;&nbsp; folks: **1,342**  &nbsp;&nbsp; `68 stars today`
...
1. [intuitem / ciso-assistant-community](https://github.com/intuitem/ciso-assistant-community)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **1,476** &nbsp;&nbsp; folks: **200**  &nbsp;&nbsp; `53 stars today`

1. [Hannibal046 / Awesome-LLM](https://github.com/Hannibal046/Awesome-LLM)
    - Awesome-LLM: a curated list of Large Language Model
    - language: **无** &nbsp;&nbsp; stars: **20,159** &nbsp;&nbsp; folks: **1,644**  &nbsp;&nbsp; `61 stars today`

1. [gitroomhq / postiz-app](https://github.com/gitroomhq/postiz-app)
    - 📨 The ultimate social media scheduling tool, with a bunch of AI 🤖
    - language: **TypeScript** &nbsp;&nbsp; stars: **15,911** &nbsp;&nbsp; folks: **2,621**  &nbsp;&nbsp; `356 stars today`
...
1. [elizaOS / eliza](https://github.com/elizaOS/eliza)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **8,682** &nbsp;&nbsp; folks: **2,281**  &nbsp;&nbsp; `2,463 stars this week`
...
1. [cline / cline](https://github.com/cline/cline)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **18,489** &nbsp;&nbsp; folks: **1,543**  &nbsp;&nbsp; `2,106 stars this week`
...
1. [elizaOS / eliza](https://github.com/elizaOS/eliza)
    - Autonomous agents for everyone
    - language: **TypeScript** &nbsp;&nbsp; stars: **8,682** &nbsp;&nbsp; folks: **2,281**  &nbsp;&nbsp; `5,999 stars this month`

1. [Byaidu / PDFMathTranslate](https://github.com/Byaidu/PDFMathTranslate)
    - PDF scientific paper translation with preserved formats - 基于 AI 完整保留排版的 PDF 文档全文双语翻译，支持 Google/DeepL/Ollama/OpenAI 等服务，提供 CLI/GUI/Docker
    - language: **Python** &nbsp;&nbsp; stars: **13,199** &nbsp;&nbsp; folks: **961**  &nbsp;&nbsp; `9,615 stars this month`
...
1. [DrewThomasson / ebook2audiobook](https://github.com/DrewThomasson/ebook2audiobook)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **4,511** &nbsp;&nbsp; folks: **295**  &nbsp;&nbsp; `3,239 stars this month`
...
1. [cline / cline](https://github.com/cline/cline)
    - Autonomous coding agent right in your IDE, capable of creating/editing files, executing commands, using the browser, and more with your permission every step of the way.
    - language: **TypeScript** &nbsp;&nbsp; stars: **18,489** &nbsp;&nbsp; folks: **1,543**  &nbsp;&nbsp; `5,210 stars this month`
